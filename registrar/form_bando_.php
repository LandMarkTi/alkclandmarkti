...
<select name="sexo" class="grid-100 tablet-grid-100 mobile-grid-100 valid" style="display:none"><option value="Masculino">selecione..</option><option>Masculino</option><option>Feminino</option></select>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent adr">
									...
									<div class="controls grid-50 tablet-grid-60 mobile-grid-100">
										<input name="End_residencial"  class="grid-100 tablet-grid-40 mobile-grid-80"  type="text" required>
									</div>
								</div>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;display:none">
									...
									<div class="controls grid-30 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;">
										<input name="opcoes_nomes"  placeholder="Afixo" class="display-block grid-100 tablet-grid-100 mobile-grid-80" type="text" id="opnome" >
									</div>
							
									<div class="controls grid-10 tablet-grid-10 mobile-grid-80" style="font-size:12px; color:#F00;">
										<input name="ck0" value="Verificar"  class="grid-80 tablet-grid-500 mobile-grid-80 push-50 valid" type="submit" onclick="return false">
									</div>
								</div>
