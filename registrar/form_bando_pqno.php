							...
							<div class="contactData">								
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="display:none">
									...
									<div class="controls grid-50 tablet-grid-60 mobile-grid-100" style="font-size:12px; color:#F00;">
										<select name="nid" class="grid-100 tablet-grid-40 mobile-grid-40 validate" data-message-class="error" data-message-icon="icon-exclamation-sign" required><option value='-'>Selecione um Kennel..</option></select>
									</div>
								</div>
...
<select name="sexo" class="grid-100 tablet-grid-100 mobile-grid-100 valid" style="display:none"><option value="Masculino">selecione..</option><option>Masculino</option><option>Feminino</option></select>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;">
									...
									<div class="controls grid-20 tablet-grid-25 mobile-grid-40" style="font-size:12px; color:#F00;display:none" >
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent adr">
									...
									<div class="controls grid-50 tablet-grid-60 mobile-grid-100">
										<input name="End_residencial"  class="grid-100 tablet-grid-40 mobile-grid-40"  type="text" required>
									</div>
								</div>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent">
									...
									<div class="controls grid-50 tablet-grid-60 mobile-grid-100">
										<input name="Raças" placeholder="Quem indicou" class="grid-100 tablet-grid-40 mobile-grid-40"  type="text" required>
									</div>
								</div>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;display:none">
									...
									<div class="controls grid-30 tablet-grid-25 mobile-grid-40" style="font-size:12px; color:#F00;">
										<input name="opcoes_nomes"  placeholder="Afixo" class="display-block grid-100 tablet-grid-100 mobile-grid-40" type="text" id="opnome" >
									</div>
