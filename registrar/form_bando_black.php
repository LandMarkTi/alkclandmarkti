...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="background-color:black">
...
<link href="jquery/health/themeB.css?xx=x" rel="stylesheet" type="text/css" />
		...
		<div class="grid-container">
			...
			<div class="grid-parent grid-100 tablet-grid-90 mobile-grid-100 padding-top-40">
				...
				<div class="header grid-parent grid-90 tablet-grid-90 mobile-grid-100 push-20 tablet-push-20 mobile-push-0 margin-bottom-20">
					...
					<h2 style="color:white;">Proposta para Associação</h2>
<h2 style="font-size:16px;color:white;">Preencha o formulário abaixo somente se tiver certeza.</h2>					
				...
				<div class="grid-parent grid-100 tablet-grid-100 mobile-grid-100 margin-top-30">
					...
					<form name="form1" id="form1" method="post" action="bando.php" onSubmit="$('.pe1').hide();$('.pe2').show();return false;">
						
						
						<fieldset>
							
							<div class="contactData">								
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="display:none">
									...
									<div class="controls grid-50 tablet-grid-60 mobile-grid-100" style="font-size:12px; color:#F00;">
										<select name="nid" class="grid-100 tablet-grid-40 mobile-grid-80 validate" data-message-class="error" data-message-icon="icon-exclamation-sign" required><option value='-'>Selecione um Kennel..</option></select>
									</div>
								</div>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;">
									...
									<div class="controls grid-50 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;">
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;">
									...
									<div class="controls grid-15 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;">
									...
									<div class="controls grid-10 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;">
										<input name="Nascimento1" placeholder="Nascimento" data-mask="99/99/9999" class="grid-100 tablet-grid-100 mobile-grid-100 valid" type="text" required>										
<select name="sexo" class="grid-100 tablet-grid-100 mobile-grid-100 valid" style="display:none"><option value="Masculino">selecione..</option><option>Masculino</option><option>Feminino</option></select>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;">
									...
									<div class="controls grid-20 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;">
										<input name="face" placeholder="Apelido"  class="grid-100 tablet-grid-100 mobile-grid-100 valid" type="text" >
									</div>
									<div class="labels grid-10 tablet-grid-40 mobile-grid-100" style="display:none">
										<label class="control-label">2º Titular:</label>
									</div>
									<div class="controls grid-20 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;display:none" >
										<input name="add" value="Adicionar"  class="grid-45 tablet-grid-40 mobile-grid-80 push-10 valid" type="submit" onclick="$('.cop').show();return false">
									</div>
								</div>

								<div class="pe1 cop control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;display:none">
									<div class="labels grid-30 tablet-grid-40 mobile-grid-100">
								...
								<div class="pe1 cop control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;">
									...
									<div class="controls grid-10 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;">
										<input name="Nascimento2" id="cp" placeholder="Nascimento" value=" " data-mask="99/99/9999" class="grid-100 tablet-grid-100 mobile-grid-100 valid" type="text" >
									</div>
									<div class="labels grid-5 tablet-grid-40 mobile-grid-100 ">
										<label class="control-label"> RG</label>
									</div>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;">
									...
									<div class="controls grid-10 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;">
										<input name="cep" id="cep" placeholder="CEP" data-mask="99999-999" onblur="$('.adr').show();" class="grid-100 tablet-grid-100 mobile-grid-100 valid" type="text" required>
									</div>
									<div class="labels grid-5 tablet-grid-40 mobile-grid-100 adr">
										<label class="control-label"> Estado</label>
									</div>
									<div class="controls grid-5 tablet-grid-25 mobile-grid-80 adr" style="font-size:12px; color:#F00;">
										<input name="estado" data-mask="**" placeholder="UF" class="grid-100 tablet-grid-100 mobile-grid-100 valid" type="text" required>
									</div>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent adr">
									...
									<div class="controls grid-50 tablet-grid-60 mobile-grid-100">
										<input name="End_residencial" placeholder="Endereço" class="grid-100 tablet-grid-40 mobile-grid-80"  type="text" required>
									</div>
								</div>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent adr" style="font-size:12px; color:#F00;">
									...
									<div class="controls grid-20 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;">
										<input name="num" placeholder="Nº" data-mask="9********" class="grid-100 tablet-grid-100 mobile-grid-100 valid" type="text" required>
									</div>
									<div class="labels grid-10 tablet-grid-40 mobile-grid-100">
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent adr" style="font-size:12px; color:#F00;">
									...
									<div class="controls grid-20 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;">
										<input name="bairro"  placeholder="bairro" class="grid-100 tablet-grid-100 mobile-grid-100 valid" type="text" required>
									</div>
									<div class="labels grid-10 tablet-grid-40 mobile-grid-100">
										<label class="control-label">Cidade:</label>
									</div>
									<div class="controls grid-20 tablet-grid-25 mobile-grid-80" style="font-size:12px; color:#F00;">
										<input name="cidade" placeholder="Cidade" class="grid-100 tablet-grid-100 mobile-grid-100 valid" type="text" required>
									</div>
								</div>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent">
									<div class="labels grid-30 tablet-grid-40 mobile-grid-100">
										<label class="control-label">Quem Indicou?</label>
									</div>
									<div class="controls grid-50 tablet-grid-60 mobile-grid-100">
										<input name="Raças" placeholder="Quem indicou" class="grid-100 tablet-grid-40 mobile-grid-80"  type="text" required>
									</div>
								</div>
								
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;">
									<div class="labels grid-30 tablet-grid-40 mobile-grid-100">
										<label class="control-label">participou:</label>
									</div>
									<div class="controls grid-50 tablet-grid-60 mobile-grid-100" style="font-size:12px; color:#F00;">
										<input name="opcoes_nomes"  placeholder="Já participou de outro MC" class="display-block grid-100 tablet-grid-100 mobile-grid-80" type="text" id="opnome" >
									</div>
								...
								<div class="pe1 control-group grid-100 tablet-grid-100 mobile-grid-100 grid-parent" style="font-size:12px; color:#F00;display:none">
									<div class="labels grid-30 tablet-grid-40 mobile-grid-100">
										<label class="control-label"></label>
									</div>
									<div class="controls grid-30 tablet-grid-25 mobile-grid-80 push-10" style="font-size:12px;color:#2b829e;">
										<p style="color:#2b829e;">O Afixo será utilizado como:</p>
									</div>
							
									<div class="controls grid-20 tablet-grid-25 mobile-grid-80" style="font-size:12px;color:#2b829e;">
								...
								<div class="pe1 grid-parent grid-50 tablet-grid-40 mobile-grid-80 push-30 tablet-push-40 mobile-push-0">
									<button type="submit" class="display-block grid-100 tablet-grid-40 mobile-grid-80" onclick="$('#form1').attr('onsubmit','').submit();" style="color: white;
background-color: silver;
border-bottom-color: darkgray;
margin-top: 5px;">Continuar</button>
								</div>
...
Tenho ciência que todas as informações concedidas para a elaboração do registro do afixo e posterior registro de cães são de minha inteira responsabilidade, declaro que li e aceito os termos dispostos e autorizo a divulgação dos meus dados dentro do Clube de benefícios do ALKC recebendo informativos e novidades sobre a Cinofília Nacional e Mundial. </p>
								...
								<div class="pe2 grid-parent grid-50 tablet-grid-40 mobile-grid-80 push-30 tablet-push-40 mobile-push-0">
									<button type="submit" class="display-block grid-100 tablet-grid-40 mobile-grid-80" onclick="$('#form1').attr('onsubmit','').submit();">Continuar</button>
								</div>
								<div class="clear"></div>
...
label {height: 31px;
font-size: 18px;color:Black;display:none;}
...
input[type="text"] {margin-bottom: 10px;color:black;border-width:2px;border-radius:6px;border-style: inset;}
