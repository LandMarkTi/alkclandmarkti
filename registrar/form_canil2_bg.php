...
if($opt['id_credenciado']!=92 && $opt['id_credenciado']!=112 && $opt['id_credenciado']!=106 && $opt['id_credenciado']!=92 && $opt['id_credenciado']!=138 && $opt['id_credenciado']!=128){$sel.='<option value="'.$opt['id_credenciado'].'">'.$opt['nome'].'</option>';} else {}
}
