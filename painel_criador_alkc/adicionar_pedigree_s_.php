...
<script type="text/javascript">
      ...
      $(document).ready(function(){
		 ...
		 $("select[name=subcategoria]").change(function(){
			...
			$('.ccc').each(function(ind,ele){$(ele).after('<select class="ccc" name="c[]">'+valor+'</select><?php if($raca==287||$raca==346||$raca==347||$raca==348){echo '<select class="var" name="var[]"><option>Pelo Curto</option><option>Pelo Longo</option><option>Anão Pelo Curto</option><option>Anão Pelo Longo</option><option>Anão Pelo Duro</option><option>Standard Pelo Curto</option><option>Standard Pelo Longo</option><option>Standard Pelo Duro</option><option>Pelo Duro</option><option>Kaninchen Pelo Curto</option><option>Kaninchen Pelo Longo</option><option>Kaninchen Pelo Duro</option></select>';} if($raca==297||$raca==363||$raca==364){echo '<select class="var" name="var[]"><option>Pelado</option><option>Pelo Longo</option></select>';} if($raca==210||$raca==355||$raca==380){echo '<select class="var" name="var[]"><option value=" ">Sem variedade</option><option>Anão</option><option>Pequeno</option><option>Médio</option></select>';} if($raca==298||$raca==351||$raca==352){echo '<select class="var" name="var[]"><option value=" ">Sem variedade</option><option>Pelo Curto</option><option>Pelo Longo</option></select>';}  if($raca==382){echo '<select class="var" name="var[]"><option value=" ">Sem variedade</option><option>Grande</option><option>Médio</option><option>Pequeno</option><option>Anão</option></select>';} ?><select class="perm" name="perm[]"><option>Com Transferência</option><option>Sem Transferência</option></select><input name="m[]" size="13" placeholder="microchip">').remove();});
                  }
                  );
