...
mysql_query("insert foto_doc values('','/painel_criador_alkc/docs/$fotonome','$id_ped','1')")or die('ee');
}
...
mysql_query("insert foto_doc values('','/painel_criador_alkc/docs/$fotonome','$id_ped','2')")or die('ee');
}
...
mysql_query("insert foto_doc values('','/painel_criador_alkc/docs/$fotonome','$id_ped','3')")or die('ee');
}
...
mysql_query("insert foto_doc values('','/painel_criador_alkc/docs/$fotonome','$id_ped','4')")or die('ee');
}
...
<body>
<script>
alert('Dados enviados');document.location='index_principal.php?act=ok';
</script>
</body>
</html>
