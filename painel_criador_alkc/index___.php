...
font-size: 19px;
line-height: 28px;">Acesso Criador</b></div>
</div>
...
<div id="login_full">
 <div id="login_margem_full">
    ...
    <div id="login_box" style="background-color:white;border:0px solid">
     ...
     <div style="margin:10px; margin-top:40px;"><center class="arial_azul18" style="font-size: 25px;">Insira seus dados para entrar:</center></div>
          <br>
