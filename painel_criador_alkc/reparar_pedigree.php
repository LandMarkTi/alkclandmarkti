...
$cria=$linha_ped['criador'];

$prop=$linha_ped['proprietario'];

$linha_ped['criador']=$prop;

$linha_ped['proprietario']=$cria;
 ...
 <div id="internas_margem_full">
	...
	<input class="parent" name="p[]"><br><input class="parent" name="p[]">
              ...
              <tr>
                <td align="right">&nbsp;</td>
                <td class="opts"><?php 
				$qcri=mysql_query("select * from selecao where id_criador=".$_SESSION['cid']);
				$cc=mysql_num_rows($qcri);

				
				$qres=mysql_query("select * from ped_res where id_ped=".$_GET['id']." and id_f=".$_GET['f']);
				$cres=mysql_num_rows($qres);
				if($cc>=1&&$cres<1&&0){?>
...
<br><a href="#">Contrato de venda</a>
				<a href="#" class="button" onclick="$('form').submit();$('#somee').hide();" id="somee" >Disponibilizar filhote</a>
				<a href="#" class="button" onclick="$('#fot').click();" style="display:none">Pagar Pedigree com foto</a> 
                <?php }
