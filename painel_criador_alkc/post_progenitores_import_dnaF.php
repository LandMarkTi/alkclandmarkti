...
if(($ss[$linha_ped['id_filhote']-4]=='Fêmea'&& ($raca==287||$raca==346||$raca==347||$raca==348||$raca==297||$raca==363||$raca==364||$raca==210||$raca==355||$raca==380||$raca==298||$raca==351||$raca==352||$raca==323||$raca==353||$raca==354||$raca==382))||($ss[$linha_ped['id_filhote']-4]=='Fêmea'&& ($linha_ped['id_raca']==$raca))) echo '<option title="'.$pref.str_replace("\"","",$nn[$linha_ped['id_filhote']]).$sulf.' '.$vl[$linha_ped['resultado']].' '.$linha_ped['registro'].($linha_ped['id_filhote']-4).' '.$mc.'" value="'.str_replace("\"","",$linha_ped['id_ped']).'">'.$pref.$nn[$linha_ped['id_filhote']].$sulf.' '.$linha_ped['registro'].($linha_ped['id_filhote']-4).' '.$mc.'</option>';
