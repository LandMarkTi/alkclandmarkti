...
<div id="principal_full">
 <div id="principal_margem_full">
	...
	<H3 style="font-size: 18px;"><img style="width: 100%" src="fundonovo9.jpg" /></H3>
		...
		<div style="height:69px;width: 55%;position:relative;top:-431px;float: right;cursor:pointer;" > </div>
