...
<?php
			...
			if($nr>=1){echo $v_p[$lp['tipo_perm']];} else echo 'Sim';
			
			?></td>
			<td><?php echo date("d/m/Y",$linha['emissao']); ?></td>
			
		        <td valign="middle"><a href="../painel_kennel/pedcode.php?id_ped=<?php echo $linha['id_ped']; ?>&id_filhote=<?=($i)?>&bt=2"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a>        </tr>
       <?php 
	}
	$i++;
	}
...
?>
        <tr>
			...
			<td><?php echo date("d/m/Y",$linhat['emissao']); ?></td>
		        <td valign="middle"><a href="../painel_kennel/pedcode.php?id_ped=<?php echo $linhat['id_ped']; ?>&id_filhote=<?=($i)?>&bt=2"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a>        </tr>
       <?php 
