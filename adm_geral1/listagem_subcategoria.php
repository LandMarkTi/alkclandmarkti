...
$sql = "SELECT c.idCategoria,
			   ...
			   s.idSubcategoria,
			   s.idCategoria,
			   s.nomeSubcategoria FROM subcategoria s JOIN categoria c ON
			   c.idCategoria = s.idCategoria   ORDER BY c.nomeCategoria,s.nomeSubcategoria ASC";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from subcategoria";
...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		$("#yesno").click(function() {
				...
				$.post("deletar_varios_subcategoria.php", 
								  {id: files
				},
								  function(retorno){
									 //$("#check").html(retorno);
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Lista de Raças          
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
				<td height="25" align="center"><input type="checkbox" value="<?php echo $linha['idSubcategoria']; ?>" name="marcar[]" class="cinput" /></td>
		        <td height="25" align="center"><?php echo $linha['idSubcategoria']; ?></td>
		        <td><?php echo $linha['nomeCategoria']; ?></td>
                <td><?php echo $linha['nomeSubcategoria']; ?></td>
		        <td valign="middle"><a href="reparar_subcategoria.php?id=<?php echo $linha['idSubcategoria']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> <a href="#" style="text-decoration:none;color:red;" onclick="var p=confirm('Deseja realmente apagar <?php echo $linha['nomeSubcategoria']; ?>?');if(p==true)$.post('deletar_subcategoria.php',{id:<?php echo $linha['idSubcategoria']; ?>},function(){location.reload();});">X</a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
