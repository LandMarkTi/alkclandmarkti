...
$sql = "SELECT * FROM conteudoindex where autor='9' ORDER BY id ASC";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from conteudoindex";
...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		$("#yesno").click(function() {
				...
				$.post("deletar_varios_noticia.php", 
								  {id: files
				},
								  function(retorno){
									 //$("#check").html(retorno);
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Lista de noticias          
          ...
          <div style="float:right; margin-right:10px;"><a class="botao" href="reparar_noticia.php"><img src="images/botoes/novo.png" border="0" title="Cadastrar Novo"></a></div>
          </div>
         <div>
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
		        ...
		        <td valign="middle"><a href="reparar_noticia.php?id=<?php echo $linha['id']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> <a href="#" id="yesno<?php echo $linha['id']; ?>"><img src="images/icons/excluir.png" title="Excluir" alt="Excluir" border="0" onClick="ConfirmaExclusao(<?php echo $linha['id']; ?>);"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
