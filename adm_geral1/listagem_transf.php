...
if (isset($_GET['nuc']) && is_null($_GET['nuc']) == false && $nuc != 0) $and .= " and pedigree.id_criador in( SELECT id_criador FROM `criadores` WHERE `id_credenciado` =$nuc)";
$bs .= "&nuc=" . $_GET['nuc'];
		...
		<div id="internas_margem_full">
			...
			<div id="internas_box">
				...
				<div id="internas_principal">
					<div class="arial_branco20" id="internas_titulo">Listagem de transferências <small style="float:right">Encontrados:
							<?echo (int)$cpn;?>
			...
			?>
													...
													<td valign="middle" colspan="2">
														...
														<a style="text-decoration:none" href="detalhe_trans_n.php?usr=<?= $linha['id_ped'] ?>&id_f=<?= $i ?>"> Ver + </a>
													</td>
												</tr>
									<?php
											}
