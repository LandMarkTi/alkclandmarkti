...
?>
        <tr>
			...
			?>
			 ...
			 <a href="#" ><img onclick="var s=confirm('Adicionar via neste pedigree?');if(s==true)$.post('deletar_via.php',{id:<?php echo $linha['id_ped']; ?>,fi:<?=$i?>},function(){location.reload();});" src="images/icons/maximizar.png" title="Add_via" alt="Add" border="0" /></a>
                <a href="http://www.megapedigree.com/painel_kennel/pedcode.php?id_ped=<?php echo $linha['id_ped']; ?>&id_filhote=<?=$i?>"><img style="max-width:20px" src="http://www.megapedigree.com/painel_credenciado/images/icons/Note-icon.png"></a>
                </td>
        </tr>
 <?php 
	}
