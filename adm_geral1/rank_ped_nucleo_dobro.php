 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Resumo Pedigree por Kennel
         ...
         <div style="margin:10px; margin-top:50px;">
            <form method="post" >
			<table width="100%" border="1"  cellspacing="6" cellpadding="0"><tr><td>Kennel</td><td>Criadores</td><td>registro<br>padrão</td><td>registro<br>inicial</td><td>registro<br>Externo</td><td>Outras<br>Entidades</td><td>Sub-total<br>registros</td><td>Transferências</td><td>chipados</td></tr>
            <?php
...
$nmc['macho']=$nmc['macho']*2+$nmc['macho']%2;

$nmc['femea']=$nmc['femea']*2 +$nmc['femea']%2;
