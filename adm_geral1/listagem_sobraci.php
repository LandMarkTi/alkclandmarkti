...
$sql = "SELECT * FROM credenciado join dados_credenciado on credenciado.id_credenciado=dados_credenciado.id_dados where id_credenciado>85 ORDER BY nome ASC";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from credenciado where id_credenciado>85";
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
			...
			<td><?php echo $linha['email']; ?></td>
		        <td valign="middle"><a href="reparar_credenciado.php?id=<?php echo $linha['id_credenciado']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> </td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
