    ...
    <div id="internas_box">
    	<div id="internas_principal">
         ...
         <div style="margin:10px; margin-top:50px;">
            <form method="post" >
			<table width="100%" border="1"  cellspacing="6" cellpadding="0"><tr><td>Raça</td><td>Machos</td><td>Fêmeas</td></tr>
            <?php
...
while($linha=mysql_fetch_assoc($qr)){if($linha['nomeSubcategoria']=='Shih Tzu'){echo '<tr><td>'.$linha['nomeSubcategoria'].'</td><td>'.$linha['macho'].'</td><td>'.$linha['femea'].'</td></tr>';$total+=$linha['macho']+$linha['femea']-2;} else {echo '<tr><td>'.$linha['nomeSubcategoria'].'</td><td>'.$linha['macho'].'</td><td>'.$linha['femea'].'</td></tr>';$total+=$linha['macho']+$linha['femea'];} }
