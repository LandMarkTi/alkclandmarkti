...
$linha['macho']=$linha['macho']*2+$linha['macho']%2;

$linha['femea']=$linha['femea']*2 +$linha['femea']%2;
 echo '<tr><td>'.$linha['nomeSubcategoria'].'</td><td>'.$linha['macho'].'</td><td>'.$linha['femea'].'</td><td>'.($linha['macho']+$linha['femea']).'</td></tr>';
$total+=$linha['macho']+$linha['femea']; }


echo '<tr><td>Total</td><td colspan="3">'.($total-2190).'</td><tr>';
//$js=substr($js,0,-1);
