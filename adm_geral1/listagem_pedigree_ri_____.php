...
$sql = "SELECT *,pedigree.nome as nc FROM  `pedigree` JOIN subcategoria ON pedigree.id_raca=subcategoria.idSubcategoria join criadores using(id_criador) join ri using(id_ped) WHERE ( 1".') '.$and.' limit '.($off+$p).', 10 ' ;
$query = mysql_query($sql) or die(mysql_error());

//Pegando tudo pg

$sql2 = "SELECT  count(*) as cpn  FROM  `pedigree` JOIN subcategoria ON pedigree.id_raca=subcategoria.idSubcategoria join criadores using(id_criador) join ri using(id_ped) WHERE ( 1".') '.$and.'  ' ;
$qn=mysql_query($sql2);
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Listagem Registro Inicial      <small style="float:right">Encontrados: <?echo (int)$cpn;?>
