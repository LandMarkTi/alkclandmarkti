...
$q_rank="SELECT COUNT( * ) AS peds, s.nomeSubcategoria ,id_cred,
...
while($linha=mysql_fetch_array($qr)){echo '<tr><td>'.$linha[1].'</td><td>'.$linha[2].'</td><td>'.$linha[0].'</td></tr>';$total+=$linha[0]; }
