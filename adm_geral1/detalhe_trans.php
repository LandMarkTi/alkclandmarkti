...
$sql2 = "SELECT id_trans_capa,proprietario,endereco,cep_t as CEP,tel_t as Telefone,cpf_t as CPF,email_t as email FROM pedigre_trocados_capa where id_trans_capa=$usr ORDER BY id_trans_capa DESC ";
