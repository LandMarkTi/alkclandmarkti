...
if (isset($_GET['nuc']) && is_null($_GET['nuc']) == false) $and .= " and registro like 'RG/$nuc/%'";
$bs .= "&nuc=" . $_GET['nuc'];

if (isset($_GET['rac']) && is_null($_GET['rac']) == false && $_GET['rac'] != '-') $and .= " and id_raca = '$rac' ";
$bs .= "&rac=" . $_GET['rac'];
		...
		<div id="internas_margem_full">
			...
			<div id="internas_box">
				...
				<div id="internas_principal">
					<div class="arial_branco20" id="internas_titulo">Listagem de Pedigree <small style="float:right">Encontrados:
							<?echo (int)$cpn;?>
						</small>
					...
					<div>
						<form id="frm_resultados" method="get" name="opts">
								...
								<tbody>
									...
									?>
												<tr>
													...
													<td valign="middle">
														<a href="reparar_pedigree2.php?id=<?php echo $linha['id_ped']; ?>&f=<?= ($i - 4) ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0" /></a>
														<a target="_new" href="/painel_kennel/pedcode.php?id_ped=<?php echo $linha['id_ped']; ?>&id_filhote=<?= $i ?>"><img style="max-width:20px" src="/painel_credenciado/images/icons/Note-icon.png"></a>
														<a href="transferenciacanil.php?id_ped=<?= $linha['id_ped'] ?>&id_filhote=<?=$i ?>" title="Transfer&ecirc;ncia de Canil"><i class="fas fa-exchange-alt" style="font-size:15px;color:black"></i></a>
							...
							<div style="margin-top:17px;margin-right:17px;float:right"></div>
