 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
         ...
         <div style="margin:10px; margin-top:50px;">
            <form  method="post" action="print_ped.jpg">
	...
	<input class="parent" name="p[]"><br><input class="parent" name="p[]">
  			...
  			</form><input type="file" id="fot" style="display:none">
           </div>
<form target="pagto" action="https://pagseguro.uol.com.br/v2/checkout/payment.html" id="pagseguro2" name="pagseguro2" method="post">
<input type="hidden" name="receiverEmail" value="bronxbullbras@gmail.com" />
<input type="hidden" name="currency" value="BRL" />
<input type="hidden" name="itemId1" id="meuid" value="ped_<?php echo $id.'_'.$_SESSION['cid'].'_';?>" />
<input type="hidden" name="itemDescription1" id="lista" value="Pagamento Pedigree" />
