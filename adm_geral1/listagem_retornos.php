...
$sql = "SELECT * FROM usuario JOIN saques ON usuario.id=saques.id_user where saques.status_retorno='Requested' ORDER BY data DESC ";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from saques";
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Pedidos de reembolso        
      ...
      <thead>
        <tr>
		  ...
		  <th width="34">Id</th>
		  <th width="206">Nome User</th>
          <th width="132">email</th>
          <th width="100">data</th>
	<th width="60">valor</th>
		  <th width="72">Alterar</th><th width="72">bloqueio</th>
        </tr>
      </thead>
      <tbody>
      <?php  while($linha = mysql_fetch_array($query)) {?>
		...
		<td><?php echo money_format("%!0.2n",$linha['valor_saque']*0.02); ?></td>
		        <td valign="middle"><a href="#" onclick="var val =confirm('marcar como devolvido?'); if(val)$.post('repara_nivelr.php',{idu : <?php echo $linha['id_saque']; ?>,value : val},function(){location.reload();}); return false;"><?php echo $linha['status_retorno'];?></a> </td>
		<td valign="middle"><a href="#" onclick="var val =confirm('bloquear?'); if(val)$.post('repara_nivelb.php',{idu : <?php echo $linha['id']; ?>,value : val},function(){location.reload();}); return false;">block</a> </td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
