...
$sql1="select * from pedigree_nucleo join subcategoria on pedigree_nucleo.id_raca=subcategoria.idSubcategoria where id_ped=".$id;
...
<div id="internas_full">
 <div id="internas_margem_full">
	...
	<input class="parent" name="p[]"><br><input class="parent" name="p[]">
		...
		<tr>
		<td><?php 
$sql_fot="SELECT * FROM  `foto_ped` where id_ped=".$_GET['id']." and id_f=".$_GET['f']." ORDER BY id_foto DESC";
...
?></td><td ><iframe src="up_foto_ri.php?id_foto=<?php echo $_GET['id'];?>&f=<?php echo $_GET['f'];?>" frameborder="0" border="0" ></iframe></td>
              </tr>
              <tr>
                <td align="right" >&nbsp;</td>
                <td id="lista_ped">
...
$.post('cotas_filhote_ri.php',{i:<?php echo ($_GET['f']+4);?>,id:<?php echo $id;?>},function(data){mydata=data;$('#lista_ped').append(listan[<?php echo ($_GET['f']+4);?>]+'-'+mydata+'ª via <input type="checkbox" name="pgs[]" value="'+<?php echo ($_GET['f']+4);?>+'"><br>');});
