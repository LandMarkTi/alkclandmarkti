         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
              ...
              <tr>
    				...
    				<td colspan="2"><input name="subcategoria" type="text" class="forms" id="nomesubcategoria" size="85" required="required" value="<?php echo $linha['nomeSubcategoria']; ?>"/></td>
			  </tr>
		 <tr>
...
">Obs.: As imagens devem ter no máximo 500kb e o tamanho exato deve ser 280 x 216 pixels </div>
                    </td>
			  </tr>
					 <tr>
...
<?php 
	...
	while($c=array_pop($set)){?>
		 <tr>
    				...
    				<td colspan="2"><input name="opcao[]" type="text" class="forms" id="subcategoria" size="55"  value="<?php echo $c; ?>"/><img onclick ="$(this).parent().prev().remove();$(this).parent().remove();" src="http://www.megapedigree.com/painel_kennel/images/icons/excluir.png"></td>
			  </tr>
                            <?php }?>
		  <tr>
              ...
              <tr>
                ...
                <input type="submit"  name="Submit" class="button" value="Atualizar" style="width: 73px;height: 30px;background-color: #30859a;color: white;"/> 
                </td>            
              </tr>
