...
$sql = "SELECT * from rgc  where pago=1 order by id desc";//confirma troca o 1 por 0
$query = mysql_query($sql) or die(mysql_error());
$trgc = mysql_num_rows($query);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php include "include_menu_esquerdo.php"; ?>
   ...
   <div class="arial_cinza2_14" style="float:right; margin-top:8px; margin-left:4px; width:auto;">Total de registros: <span class="arial_cinza2_14" style="font-weight:bold;"><?php echo $trgc; ?></span></div>
