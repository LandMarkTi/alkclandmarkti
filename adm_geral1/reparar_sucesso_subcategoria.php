...
$sql = "UPDATE subcategoria SET idCategoria='$categoria', nomeSubcategoria='$subcategoria',regrasublocal='$regra',pelagem='$pelagem',conteudo='$conteudo', pais_raca='$pais_raca' $f WHERE idSubcategoria='$id'";
