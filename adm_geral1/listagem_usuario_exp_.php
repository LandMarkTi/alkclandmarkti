...
$sql = "SELECT * FROM criadores  where  id_criador in ($set 0) and id_credenciado<=85   ORDER BY id_criador DESC limit 1928";//concat( `ano_assinatura` , `mes_assinatura` , `dia_assinatura` ) > ".date("Ymd",time()-31556926)."
...
<?php include "menu_esquerdo.php"; ?>
   ...
   <div id="internas_busca">
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Listagem expirados        
