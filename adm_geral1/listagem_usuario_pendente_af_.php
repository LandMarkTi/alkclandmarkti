...
<div ><form>Filtrar por <input placeholder="nome,cpf,No" name="nome"><select name="estado"><option value="-">Estado..</option>
 ...
 <select name="knl"><option value="-">Kennel..</option><?php echo $sel; ?></select>

  <select name="raca"><option value="-">Raça..</option><?php
...
$sqlcateg = "SELECT * FROM subcategoria where idSubcategoria not in(346,347,348,355,380,351,352) $fraca ORDER BY nomeSubcategoria ASC";
						...
						while($linhacateg = mysql_fetch_array($querycateg)){
							echo"
								<option value='".$linhacateg['nomeSubcategoria']."'>$linhacateg[nomeSubcategoria]</option>
							";	
						}


?></select> <input value="OK" type="submit" style="width: 30px;display:inline;">      
           </form>
          </div>
         <div>
