...
$sql = "SELECT * FROM criadores  where  id_criador NOT in ($set 0) and id_credenciado>85  ORDER BY id_criador DESC ";//and id_credenciado>=85 and concat( `ano_assinatura` , `mes_assinatura` , `dia_assinatura` ) > ".date("Ymd",time()-31556926)."
