...
mysql_query("INSERT INTO `pag_trans_tarja` (`id_pag`, `id_ped`, `id_f`, `data_pg`) VALUES (NULL, ".$idped.", ".$idfb.", NOW());");

$pss=strrev($idped).str_pad($idfb,2,"0",STR_PAD_LEFT);

mysql_query("update pedigre_trocados_tarja SET rastreio='".md5($pss)."' where id_ped='".$idped."' and id_f='".$idfb."'");
...
<br><br>
Site da PETZ com desconto de 10% sobre todos os produtos anunciados é uma exclusividade ALKC:

 <br><br>
https://bit.ly/2OwRgPh
