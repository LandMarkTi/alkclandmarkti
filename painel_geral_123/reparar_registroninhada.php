...
mysql_query("update paginas_internas set registroninhada='$bloco'") or die (mysql_error());
mysql_query("update paginas_internas set registroninhada_titulo='$titulo'") or die (mysql_error());
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
  			  <tr>
    				...
    				<td><input name="titulo" value="<?php echo $linha['registroninhada_titulo'];?>" type="text" class="forms" id="titulo" size="65" required="required"/></td>
			  </tr>          
              ...
              <tr>
    				...
    				<td>
   				    <textarea name="bloco" id="descricao" cols="67" rows="10" class="forms"><?php echo htmlentities($linha['registroninhada'],ENT_QUOTES);?></textarea></td>
			  </tr>
