...
$foto=$fotonome;
$insert=mysql_query("INSERT INTO medalha values('','$nome','$regra','$foto')")or die('err');
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Novo Cadastro Medalha
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
  			  ...
  			  <tr>
    				<td align="right"><label for="nome" class="arial_cinza2_12" >Nome Medalha:</label></td>
    				<td><input name="nome" type="text" class="forms" id="nome" size="50" required="required"/></td>
			  </tr>
              
              <tr style="display:none;">
    				<td align="right"><label for="comissao" class="arial_cinza2_12" >Descrição:</label></td>
    				<td><input name="regra" value="99999" type="text" class="forms" id="comissao" size="50" required="required"/>
    				  </td>
			  </tr>
              
              <tr>
    				<td align="right"><label for="pontuacao" class="arial_cinza2_12" >Foto:</label></td>
    				<td><input name="foto" type="file" class="forms" id="pontuacao" size="50" required="required"/>
   				    </td>
			  </tr>
              <tr>
                <td align="right">&nbsp;</td>
