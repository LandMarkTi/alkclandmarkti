...
$idc=(int)$_GET['id'];
$sql = "select * from ped_serie join credenciado using(`id_credenciado`) where ped_serie.id_credenciado =".$idc." ";
   ...
   <form method="post" action="#" id="frm-filtro">
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
		        ...
		        <td height="25" align="center"><?php echo $linha['id_serie']; ?></td>
		        <td><?php echo $linha['nome']; ?></td>
			<td><?php echo date("d/m/Y",$linha['data_add']); ?></td>
			<td><?php echo $linha['tipo_serie']; ?></td>
