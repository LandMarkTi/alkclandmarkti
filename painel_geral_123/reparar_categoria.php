 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
         ...
         <div style="margin:10px; margin-top:50px;">
            <form action="reparar_sucesso_categoria.php" method="post">
            <input type="hidden" name="id" id="id" value="<?php echo $_GET['id']; ?>" />
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
            
  			  <tr>
    				<td align="right"><label for="nome" class="arial_cinza2_12" >Nome Categoria:</label></td>
    				<td><input name="nome" type="text" class="forms" id="nome" size="85" required="required" value="<?php echo $linha['nomeCategoria']; ?>"/></td>
			  </tr>
			 <tr>
    				<td align="right"><label for="nome" class="arial_cinza2_12" >Regra:</label></td>
    				<td><input name="regra" type="text" class="forms" id="nome" size="85" required="required" value="<?php echo $linha['regralocal']; ?>"/></td>
			  </tr>
