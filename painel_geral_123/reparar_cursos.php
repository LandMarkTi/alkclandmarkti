...
if($id==0){mysql_query("insert into conteudoindex values('','$tit','25','/images/banner/original/$fotonome','$bloco')");die("<script>alert('Dados Enviados!');location='index_principal.php';</script>");}
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
                ...
                <tr>
    				...
    				<td><input name="foto" value="<?php echo $linha['foto'];?>" type="file" class="forms" id="tituloAposta" size="65" /></td>
			  </tr>
