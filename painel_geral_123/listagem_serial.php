...
$sql = "select count(*) as cc,`id_credenciado` as id_c,credenciado.nome as nm from ped_serie join credenciado using(`id_credenciado`) where ped_serie.id_credenciado in(SELECT distinct(`id_credenciado`) FROM `ped_serie` WHERE 1) GROUP by `id_credenciado`
";
