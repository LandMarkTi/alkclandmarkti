...
$sql = "SELECT * FROM credenciado where id_adm = 1 ORDER BY nome ASC";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from credenciado";
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Lista dos Credenciados         
      ...
      <thead>
        <tr>
		  ...
		  <th width="42">Id</th>
		  <th width="301">Nome </th>
		  <th width="301">Email </th>
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
		        ...
		        <td height="25" align="center"><?php echo $linha['id_credenciado']; ?></td>
		        <td><?php echo $linha['nome']; ?></td>
			<td><?php echo $linha['email']; ?></td>
		        <td valign="middle"><a href="reparar_credenciado.php?id=<?php echo $linha['id_credenciado']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> <a href="#" id="yesno<?php echo $linha['id_credenciado']; ?>"><img src="images/icons/excluir.png" title="Excluir" alt="Excluir" border="0" onClick="ConfirmaExclusao(<?php echo $linha['id_credenciado']; ?>);"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
