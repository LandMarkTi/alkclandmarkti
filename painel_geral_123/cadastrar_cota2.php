...
$sel='<option value="17">Sorocaba</option><option value="44">Núcleo Adm</option>';
...
$sql_list="INSERT INTO `ped_serie` (`id_serie`, `id_credenciado`, `id_ped`, `id_filhote`, `numero_serie`, `tipo_serie`, `status`, `data_add`) VALUES ";
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Adicionar cotas 
         ...
         <div style="margin:10px; margin-top:50px;">
            <form action="cadastrar_cota2.php" method="post">
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
            
  			  <tr>
    				<td align="right"><label for="nome" class="arial_cinza2_12" >Credenciado</label></td>
    				<td><select name="nid"><option value="">Escolha um Núcleo...</option><?php echo $sel;?></select></td>
			  </tr>
			  <tr>
