...
$nome=$_POST['nome'];
$regra=$_POST['regra']*100;
$regra=(int)$regra;


$foto=(int)$_POST['foto'];
$insert=mysql_query("INSERT INTO nivel values('','$nome','$foto','$regra')")or die('err');
...
<script type="text/javascript">
      ...
      $(document).ready(function(){
         	$('#cent_mask').maskMoney("thousands:'', decimal:'.'");
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Novo Cadastro Nivel
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
  			  ...
  			  <tr>
    				<td align="right"><label for="nome" class="arial_cinza2_12" >Nome Nivel:</label></td>
    				<td><input name="nome" type="text" class="forms" id="nome" size="20" required="required"/></td>
			  </tr>
              
              <tr>
    				<td align="right"><label for="comissao" class="arial_cinza2_12" >Comissão:</label></td>
    				<td><input name="regra" type="text" class="forms" id="cent_mask" size="20" required="required"/>
    				  </td>
			  </tr>
              
              <tr>
    				<td align="right"><label for="pontuacao" class="arial_cinza2_12" >Pontuação:</label></td>
    				<td><input name="foto" type="text" class="forms" id="pontuacao" size="20" required="required"/>
   				    </td>
			  </tr>
              <tr>
                <td align="right">&nbsp;</td>
