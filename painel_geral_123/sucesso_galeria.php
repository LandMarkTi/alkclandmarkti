...
move_uploaded_file($fototemp,'../site/images/noticia/'.rawurlencode($fotonome));


$sql = "INSERT INTO `galeria` VALUES ('','".rawurlencode($fotonome)."','$legenda','".time()."')";
    ...
    <div id="internas_box">
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Adicionado com Sucesso
            ...
            <div style="float:right;"><a class="botao" href="cadastrar_galeria.php"><img src="images/botoes/novo.png" border="0" title="Cadastrar Novo"></a></div>
          </div>
