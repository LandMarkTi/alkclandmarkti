...
$sql = "SELECT * from rgc join qrcode on id=id_ped where pago=0 order by id desc";
...
<?php include "include_menu_esquerdo.php"; ?>
   ...
   <div class="arial_cinza2_14" style="float:right; margin-top:8px; margin-left:4px; width:auto;">Total de registros: <span class="arial_cinza2_14" style="font-weight:bold;" id="ttt"><?php //js ?></span></div>
   
   </div>
   
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">RG PET          
