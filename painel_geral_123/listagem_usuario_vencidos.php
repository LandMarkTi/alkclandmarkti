...
$sql = "SELECT * FROM criadores join aprovados using (id_criador) where  1 and concat( `ano_assinatura` , `mes_assinatura` , `dia_assinatura` ) < ".date("Ymd",time()-31556926)."  group by id_criador ORDER BY id_criador DESC ";//
...
<?php //include "menu_esquerdo2.php"; ?>
    <div id="internas_box">
