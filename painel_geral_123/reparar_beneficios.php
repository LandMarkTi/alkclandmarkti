...
if($fotonome!=''){
mysql_query("update paginas_internas set beneficios_foto='images/banner/original/$fotonome'") or die (mysql_error());
}
}

mysql_query("update paginas_internas set beneficios='$bloco'") or die (mysql_error());
mysql_query("update paginas_internas set beneficios_titulo='$titulo'") or die (mysql_error());
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
  			  <tr>
    				...
    				<td><input name="titulo" value="<?php echo $linha['beneficios_titulo'];?>" type="text" class="forms" id="titulo" size="65" required="required"/></td>
			  </tr>          
                <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >Foto :</label></td>
    				<td><input name="foto" value="<?php echo $linha['beneficios_foto'];?>" type="file" class="forms" id="foto" size="65" /></td>
			  </tr>
              ...
              <tr>
    				...
    				<td>
   				    <textarea name="bloco" id="descricao" cols="67" rows="10" class="forms"><?php echo htmlentities($linha['beneficios'],ENT_QUOTES);?></textarea></td>
			  </tr>
