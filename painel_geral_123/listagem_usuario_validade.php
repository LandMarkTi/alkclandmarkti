...
$sql = "SELECT * FROM criadores  where  id_criador in ($set 0) and id_criador>13000  ORDER BY id_criador DESC ";//
...
<?php include "include_menu_esquerdo.php"; ?>
   ...
   <div class="arial_cinza2_14" style="float:right; margin-top:8px; margin-left:4px; width:auto;">Total de registros: <span class="arial_cinza2_14" style="font-weight:bold;"><?php echo $nn; ?></span></div>
    	...
    	<div id="internas_principal">
         ...
         <table cellspacing="0"  width="100%" id="demotable1">
      <thead>
        <tr>
          <th width="32"><input type="checkbox" value="1" id="marcar-todos" name="marcar-todos" /></th>
		  <th width="34">Validade</th>
		  <th width="300">Nome do Canil</th>
          <th width="127" colspan="2">Nome do proprietário</th>
          <!--th width="127">Data adesão</th-->          
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <td width="34">Validade</td>
		  <td width="300">Nome do Canil</td>
          <td width="127">Nome do proprietário</td>
          <!--th width="127">Data adesão</th-->          
          <!--th width="344" colspan="3">Status</th-->
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
		        ...
		        <td height="25" align="center"><?php $v=(int)($linha['id_criador']/50);echo $v; ?></td>
		        <td><?php echo $linha['nome_completo']; ?> </td>
                <td><?php echo substr($linha['nome'],0,20).' '.substr($linha['sobrenome'],0,20).'..'; ?> </td>
                <!--td><?php //echo $linha['dia_assinatura']."/".$linha['mes_assinatura']."/".$linha['ano_assinatura']; ?></td>                
                <td>Aprovado</td-->
                
                <!--td><?php //echo $linha['nome']; ?></td-->
		        <td valign="middle"> <a href="#" id="yesno<?php echo $linha['id_criador']; ?>"><img src="images/icons/excluir.png" title="Excluir" alt="Excluir" border="0" onClick="ConfirmaExclusao(<?php echo $linha['id_criador']; ?>);"/></a><a href="detalhe_criador.php?usr=<?php echo $linha['id_criador']; ?>"><img width="20px" height="20px" src="images/icons/Note-icon.png" ></a><a href="imprime_canil/imprime.php?usr=<?php echo $linha['id_criador']; ?>"><img width="16px" height="16px" src="images/icons/print.png" ></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
