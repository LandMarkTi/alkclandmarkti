 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
         ...
         <div style="margin:10px; margin-top:50px;">
            <form action="reparar_sucesso_video.php" method="post">
            <input type="hidden" name="id" id="id" value="<?php echo $_GET['id']; ?>" />
            &nbsp;
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="right" class="arial_cinza2_12">Video:</td>
                <td><input name="video" type="url" required class="forms" id="video" value="<?php echo $linha['video']; ?>" size="85"/></td>
              </tr>
              <tr><td>&nbsp;</td>
              <td>&nbsp;</td>
              </tr>
              <tr>
                ...
                <td><input name="legenda" type="text" required class="forms" id="legenda" value="<?php echo $linha['legenda']; ?>" size="85"/></td>
              </tr>
