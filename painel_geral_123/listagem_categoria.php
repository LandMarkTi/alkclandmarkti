   ...
   <form method="post" action="#" id="frm-filtro">
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
		        ...
		        <td valign="middle"><a href="reparar_categoria.php?id=<?php echo $linha['idCategoria']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
