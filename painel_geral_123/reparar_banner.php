...
if($_POST){
	...
	if($tipo_banner == 0)$mini -> resize(710,341); else $mini -> resize(175,400); 
	$mini -> save("../site/images/banner/$fotonome");
	
	$sqla = "UPDATE banner SET foto = '../site/images/banner/original/$fotonome' WHERE idBanner = '$id'";
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
  			  ...
  			  <tr style="display:none">
                    ...
                    <select name="tipo_banner" id="tipo_banner" class="forms" onChange="alteraImagem(this.value)">
                        ...
                        <option value="0" >Banner Rotativo</option>
    				    <option value="1">Banner Esquerda</option>
			        </select>
                    </td>
			  </tr>
...
"><img src="../site/images/alerta.png" align="left" style="margin:2px;">Obs.: As imagens devem ter no máximo 500kb e o tamanho exato deve ser 710 x 340 pixels </div>
</td>
</tr></table>    
