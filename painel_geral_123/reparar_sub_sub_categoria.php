...
$sql = "SELECT * FROM subsubcategoria WHERE idSubSubCategoria='$_GET[id]'";
			...
			$("#yesno").click(function() {
				$.post("deletar_subcategoria.php",
					{id: <?php echo $_GET['id']; ?>},
						...
						window.location="listagem_sub_sub_categoria.php";
        			 } 
        		);
		});	
	});
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
         ...
         <div style="margin:10px; margin-top:50px;">
            <form action="reparar_sucesso_sub_sub_categoria.php" method="post">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
              ...
              <tr>
                ...
                <option value="<?php echo $linha['idSubCategoria']; ?>">Deixar Sub-Categoria Atual</option>
                </select></td>            
              </tr>
              
              <tr>
    				<td align="right"><label for="subsubcategoria" class="arial_cinza2_12" >Sub-Sub-Categoria</label></td>
    				<td><input name="subsubcategoria" type="text" class="forms" id="subsubcategoria" size="85" required="required" value="<?php echo $linha['nomeSubSubCategoria']; ?>"/></td>
			  </tr>
 			<tr>
    				<td align="right"><label for="subsubcategoria" class="arial_cinza2_12" >regra</label></td>
    				<td><input name="regra" type="text" class="forms" id="subsubcategoria" size="85" required="required" value="<?php echo $linha['regrasubsublocal']; ?>"/></td>
			  </tr>
