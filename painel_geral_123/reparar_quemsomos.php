...
if($fotonome!=''){
mysql_query("update paginas_internas set foto_quemsomos='images/banner/original/$fotonome'") or die (mysql_error());
}
}

mysql_query("update paginas_internas set quemsomos='$bloco'") or die (mysql_error());
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
                ...
                <tr>
    				...
    				<td><input name="foto" value="<?php echo $linha['foto_quemsomos'];?>" type="file" class="forms" id="foto" size="65" /></td>
			  </tr>
              ...
              <tr>
    				...
    				<td>
   				    <textarea name="bloco" id="descricao" cols="67" rows="10" class="forms"><?php echo htmlentities($linha['quemsomos'],ENT_QUOTES);?></textarea></td>
			  </tr>
