...
$pdf->Cell(16.5, 2, $canil , 0 , 1 , 'C' );

$pdf->SetXY(6.8,11.7);
$pdf->SetFont('arial','',16);
$pdf->Cell(16.5, 1, $n_registro , 0 , 1 , 'L' );
$pdf->SetXY(6.8,12.9);
$pdf->Cell(16.5, 1, $proprietario , 0 , 1 , 'L' );
$pdf->SetXY(6.9,14.1);
$pdf->Cell(16.5, 1, $cidade_estado , 0 , 1 , 'L' );
$pdf->SetXY(7.3,15.3);
$pdf->Cell(16.5, 1, $data_abertura , 0 , 1 , 'L' );
$pdf->SetXY(7.7,16.5);
$pdf->Cell(16.5, 1, $validade , 0 , 1 , 'L' );
