...
$sql = "SELECT * FROM medalha ORDER BY id DESC ";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from medalha";
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Lista de Medalhas          
          ...
          <div style="float:right; margin-right:10px;"><a class="botao" href="cadastrar_medalha.php"><img src="images/botoes/novo.png" border="0" title="Cadastrar Novo"></a></div>
          </div>
         <div>
      ...
      <thead>
        <tr>
		  ...
		  <th width="34">Id</th>
		  <th width="356">Nome Medalha</th>
          <th width="132">Regra</th>
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
		        ...
		        <td><?php echo $linha['nomeMedalha']; ?></td>
                <td><?php echo str_replace("99999",'sem regra',$linha['regra']); ?> </td>
                <td><?php echo $linha['fotoM']; ?></td>
		        <td valign="middle"><a href="reparar_medalha.php?id=<?php echo $linha['id']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> <a href="#" id="yesno<?php echo $linha['id']; ?>"><img src="images/icons/excluir.png" title="Excluir" alt="Excluir" border="0" onClick="ConfirmaExclusao(<?php echo $linha['id']; ?>);"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
