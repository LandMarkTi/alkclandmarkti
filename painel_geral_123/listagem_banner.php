...
$sql = "SELECT * FROM banner where tipoBanner='0' ORDER BY tipoBanner ASC ";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from banner";
...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		$("#yesno").click(function() {
				...
				$.post("deletar_varios_banner.php", 
								  {id: files
				},
								  function(retorno){
									 //$("#check").html(retorno);
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Lista de Banner          
         ...
         &nbsp;
         <table cellspacing="0" summary="Tabela de Banner" width="100%">
      <thead>
        <tr>
          <th width="32"><input type="checkbox" value="1" id="marcar-todos" name="marcar-todos" /></th>
		  <th width="34">Id</th>
		  <th width="112">Tipo Banner</th>
          <th width="341">Link</th>
          <th width="145">Imagem</th>
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
				<td height="25" align="center"><input type="checkbox" value="<?php echo $linha['idBanner']; ?>" name="marcar[]" class="cinput" /></td>
		        <td height="25" align="center"><?php echo $linha['idBanner']; ?></td>
		        <td><?php echo $linha['tipoBanner']==0?("Banner Rotativo"):("Banner Esquerda"); ?></td>
                <td><?php echo $linha['link']; ?></td>
                <td><?php echo str_replace("http://www.megapedigree.com/site/images/banner/","",$linha['foto']); ?></td>
		        <td valign="middle"><a href="reparar_banner.php?id=<?php echo $linha['idBanner']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> <a href="#" id="yesno<?php echo $linha['idBanner']; ?>"><img src="images/icons/excluir.png" title="Excluir" alt="Excluir" border="0" onClick="ConfirmaExclusao(<?php echo $linha['idBanner']; ?>);"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
