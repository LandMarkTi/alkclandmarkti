...
<ul id="jsddm">
    ...
    <div class="menu_box"><a href="#" class="oswald_branco16">Menu Principal</a></div>  
          <ul style="visibility: hidden; width: 175px;">
              <li><a class="botao" href="listagem_pedigree.php">Últimas Solicitações</a></li>
               <li><a class="botao" href="listagem_enviados.php">Contatos Efetuados</a></li>  
              <li><a class="botao" href="listagem_pedigree_pur.php">Solicitação Kit Purina</a></li>  
              <li><a class="botao" href="listagem_pedigree_conf.php">Contatos Kit Purina</a></li>  
              </ul>    
    </li>
</ul>
  ...
  <div id="header_box_menu_texto_d" class="arial_branco11">Usuário : <b>Purina</b></div>
