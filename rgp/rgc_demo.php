...
<br>
<br>
O CADB –CADASTRO DE ANIMAIS DOMESTICOS DO BRASIL AGRADEÇE O SEU CADASTRO.
<br><br>
VOCÊ ACABA DE FAZER A INCLUSÃO DIGITAL DO SEU PET!
<br><br>
Visualize o documento nº '.$id_rgc.' abaixo:
<br>
<br>
http://www.rgpet.pet/consultar
<br>
<br>
Caso queira o documento impresso acesse o site:
<br>
<br>
http://www.rgpet.pet/loja
<br>
<br><br>
<br>
</body></html>
...
$headers .= "From: rg@rgpet.club\n"; // remetente
$headers .= "Return-Path: rg@rgpet.club\n"; // return-path
if($_POST['crmv']=="Lcadb"){$envio = mail($email, "Cadastro RG PET", "$mensagemHTML", $headers,'-rg@rgpet.club');}
...
echo "<html><body><script>alert('Cadastrado Enviado.Seu RG PET :".$id_rgc." ');</script>Obrigado!</body></html>";
die();
}
...
<H1 style="color:#<?php if(isset($_GET['cadb'])===true)echo '002e5d'; else echo '428F25'; ?>;opacity:1;font-size: 27px;">Formulário RG PET </h1>
<br>
Nome do Proprietário: <br>
               ...
               Cidade:<br>
				...
				<br>
<H1 style="color:#<?php if(isset($_GET['cadb'])===true)echo '002e5d'; else echo '428F25'; ?>;opacity:1;font-size: 27px;">Dados do Animal </h1>
		Tipo:<br>
		<select name="tipo" >
...
<br>
<?php if(isset($_GET['cadb'])===true){?><input name="crmv" type="hidden" value="Lcadb"><?php }else{?>
  CRMV: 
