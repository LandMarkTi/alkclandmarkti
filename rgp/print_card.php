...
<div id="frame">
<img src="https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl=<?php echo rawurlencode('http://rgpetsystem.club/ver_carteirinha.php?id='.$_GET['id']);?>&choe=UTF-8" style="position: relative;left: 738px;top: -368px;">
</div>
</body>
</html>
