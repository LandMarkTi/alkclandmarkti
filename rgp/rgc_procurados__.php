...
overflow: hidden;
margin-bottom: -10px;
width: 145px;'><img style='width:190px;margin-left: -26px;' src=\"".$l['foto']."\"></div><br><center style='background-color:white;color:black;width: 180px;'>".$l['tipo'].' '.$l['raca'].' '.$vs[$l['sexo']].'<br>Local: '.substr($l['endereco'],0,15)."<br>".$l['cidade']."-".$l['estado']."</span>
