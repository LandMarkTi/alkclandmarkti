...
i();a.eq(0).addClass("rsMainSlideImage");b.iW&&b.iH&&(b.isLoaded||j._p2(b),e());b.isLoading=!0;if(b.isBig)k("<img/>").on("load.rs error.rs",function(){g([this])}).attr("src",b.image);else{b.loaded=[];b.imgLoaders=[];for(a=0;a<b.images.length;a++){var d=k("<img/>");b.imgLoaders.push(d);d.on("load.rs error.rs",function(){b.loaded.push(this);b.loaded.length===b.imgLoaders.length&&g(b.loaded)}).attr("src",b.images[a])}}}}else b.isRendered=!0,b.isLoaded=!0,b.isLoading=!1,e(!0)}function g(c){if(c.length){var c=
c[0],d=c.src;if(j.st.fullscreen&&d&&-1===d.indexOf(b.image))(c=b.holder.children())&&1<c.length&&h();else if(b.iW&&b.iH)a();else if(b.iW=c.width,b.iH=c.height,b.iW&&b.iH)a();else{var e=new Image;e.onload=function(){e.width?(b.iW=e.width,b.iH=e.height,a()):setTimeout(function(){e.width&&(b.iW=e.width,b.iH=e.height);a()},1E3)};e.src=c.src}}else a()}function a(){b.isLoaded=!0;b.isLoading=!1;e();h();d()}function e(){if(!b.isAppended){var a=j.st.visibleNearby,c=b.id-j._n;if(!f&&!b.appendOnLoaded&&j.st.fadeinLoadedSlide&&
...
k(this);if("object"===typeof b||!b)c.data("royalSlider")||c.data("royalSlider",new u(c,b));else if((c=c.data("royalSlider"))&&c[b])return c[b].apply(c,Array.prototype.slice.call(f,1))})};k.fn.royalSlider.defaults={slidesSpacing:8,startSlideId:0,loop:!1,loopRewind:!1,numImagesToPreload:4,fadeinLoadedSlide:!0,slidesOrientation:"horizontal",transitionType:"move",transitionSpeed:15000,controlNavigation:"bullets",controlsInside:!0,arrowsNav:!0,arrowsNavAutoHide:!0,navigateByClick:!0,randomizeSlides:!1,sliderDrag:!0,
...
b=c.breakpoint&&a.width<c.breakpoint?c.breakpointCenterArea:c.centerArea;a._g?(a._z3*=b,a._g7.css({height:a._a4,width:a._z3/b}),a._c=a._z3*(1-b)/2/b):(a._a4*=b,a._g7.css({height:a._a4/b,width:a._z3}),a._c=a._a4*(1-b)/2/b);c.navigateByCenterClick||(a._p=a._g?a._z3:a._a4);c.center&&a._d1.css("margin-"+(a._g?"left":"top"),a._c)}))};d.rsModules.visibleNearby=d.rsProto._e7})(jQuery);
