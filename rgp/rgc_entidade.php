...
echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=rgc_login.php"."'>";
die();

}

if($fototamanho>3000000){$resultado = "alert('Arquivo enviado passou do limite de 3MB!');";
echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=rgc_entidade.php'>";
}
...
<H1 style="color:#428F25;opacity:1;font-size: 27px;">Formulário de credenciamento </h1>
<br>
Nome: <br>
...
  
                ...
                <input name="crmv" type="hidden"  value="C<?=mt_rand(1000000,9000000);?>">                                
<br>
                RG:<br>
               ...
               Cidade:<br>
				...
				<br>
<H1 style="color:#428F25;opacity:1;font-size: 27px;">Dados da entidade (se houver)</h1>
		Razão social:<br>
		<input name="tipo" ><br>
...
<br>                                             
Sem fins lucrativos: <br><input type="checkbox" value="ong" onclick="add_pre();" value="ong" style="width:25px;">                		                          
<br>
Senha:<br>
...
var cr=$('input[name=crmv]').val();

$('input[name=crmv]').val('O'+cr);
