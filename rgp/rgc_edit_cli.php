...
$sql = "update med_vet2 set nome_med='$nome',rg='$rg', cpf='$cpf', endereco='$endereco', bairro='$bairro', cidade='$cidade', estado='$estado', cep='$cep', tel_res='$tel_res', tel_com='$tel_com', celular='$celular', email='$email',  nascimento='$nascimento' where id = '$id_ped' ";  
...
echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=rgc_edit_cli.php'>";
}
...
<H1 style="color:#428F25;opacity:1;font-size: 20px;">Editar Dados </h1>

Nome: <br>
                <input type="text" name="nome" id="nome" size="30" value="<?php echo $linha['nome_med'];?>" >
                <br>
                RG:<br>
...
?>" >                
			...
			Tipo<br>
				...
				CRMV<br>
				<input type="text" name="crmv" id="qrcode" size="6" value="<?php echo $linha['crmv_med'];?>" readonly><br>
