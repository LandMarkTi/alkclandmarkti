...
<div class="header_full">
 <div class="header_margem_full">
  ...
  <div class="header_logo" style="width: 450px;"> <a href="index.php" style="text-decoration:none"><img width="350px" height="87px" src="<?php if(isset($_SESSION['header']))echo './'.$_SESSION['header'];else echo './images/logo_header.png'; ?>"/>
</a>
...
<li>	<div class="menu_box"><a href="index.php" class="oswald_branco16">INÍCIO</a></div></li>
...
<li><a href="racas.php?grupo=17">GRUPO 08 - Cães Brasileiros</a></li>
</ul>
</li>
<li>    <div class="menu_linha"><img src="images/linhas/linha_sep_menu.png"/></div></li>
