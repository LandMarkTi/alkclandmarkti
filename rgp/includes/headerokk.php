...
<div class="header_full">
 <div class="header_margem_full">
  ...
  <div class="header_logo"> <a href="index.php"><img width="350px" height="87px" src="<?php if(isset($_SESSION['header']))echo './'.$_SESSION['header'];else echo './images/logo_header.png'; ?>"/></a>
  </div>
...
<li><a href="racas.php?grupo=17">GRUPO 08 - Miscelânea</a></li>
</ul>
</li>
<li>    <div class="menu_linha"><img src="images/linhas/linha_sep_menu.png"/></div></li>
