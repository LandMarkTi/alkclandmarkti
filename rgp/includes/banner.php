 ...
 <iframe src="./banner.php" style="width: 720px;border: 0px;height: 368px;float: left;margin-top: 8px;" frameBorder="0" scrolling="no">
    ...
    <div class="banner_login"><form method="post" onsubmit="return troca_action();" id="mf">
    	<div class="margin10">
		  ...
		  <tr>
                    <td align="left" valign="middle"><span style="display:none;" class="arial_cinza1_10" style="display:none;padding:5px;display:block;position:relative;top:-9px;">Criador<input type="radio" checked="checked" name="ac" value="http://www.megapedigree.com/site/env_login.php"></span></td>																		
                    <td align="right" valign="middle"><span  style="display:none;" class="arial_cinza1_10" style="display:none;padding:5px;display:block">Credenciado<input  type="radio" name="ac" value="http://www.megapedigree.com/painel_credenciado/env_login2.php"></span><br></td>

                  </tr>
                  <tr style="font-size: 13px;">
                    <td align="left" valign="middle"><a href="http://www.megapedigree.com/painel_credenciado/FORMULARIO_FILIACAO4.php" class=" verdeon" style="border: 1px solid;border-radius: 3px;padding: 7px;margin-top: 1px;font-family: 'Oswald', Arial, sans-serif;text-decoration:none;">Cadastro</a></td>
    ...
    <div class="banner_busca" style="height:84px;">
      <div class="margin10">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
          ...
          <tr>
            <td><form action="busca_pedigree.php" method="post">
              <input name="busca_chip" type="text" class="login_forms_consultar" id="consultar" placeholder="Ex. RG/SP 001" />
            <input class="botao" type="image" src="images/botoes/buscar.jpg" align="absmiddle" onclick=""/>
	</form></td>
...
<div class="banner_busca" style="height: 84px;margin-top: 6px;margin-bottom: 18px;">
      <div class="margin10">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="oswald_cinza16">CONSULTAR RG PET</td>
          </tr>
      
          <tr>
            <td><form action="busca_rgc_capa.php" method="post">
              <input name="busca_chip" type="text" class="login_forms_consultar" id="consultar"  placeholder="Ex.121" />
            <input class="botao" type="image" src="images/botoes/buscar.jpg" align="absmiddle" onclick=""/>
	</form></td>
    <tr><td class="arial_cinza11">Somente RG pet Sobraci</td></tr>
          </tr>
        </table>
      </div>
    </div>
