...
<img width="87" height="87px" src="./images/icones/LOGONOVAPEDIGREE.png">
  ...
  <div class="header_atendimento" style="position:relative; z-index:3;">
	...
	if($_SESSION['cidade']=='Cotia'||$_SESSION['cidade']=='Sorocaba')echo '<img src="images/botoes/encontre_nucleo.jpg" onclick="location=\'http://www.megapedigree.com.br/site/credenciado.php?consultar=%25\';" class="botao">'; else echo $_SESSION['tel_contato']; 
...
<li><a href="http://www.megapedigree.com.br/site/delivery.php">Delivery</a></li>
