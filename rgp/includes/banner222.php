    ...
    <div class="banner_busca">
       ...
       <div class="margin10">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><form action="busca_rgc.php">
              <input name="consultar" type="text" class="login_forms_consultar" id="rgc" onfocus="if(this.value=='Ex. RG/SP 001') {this.value='';}" onblur="if(this.value=='') {this.value='Ex. RG/SP 001';}" value="Ex. RG/SP 001" />
            <input class="botao" type="image" src="images/botoes/buscar.jpg" align="absmiddle" />
	</form></td>
          </tr>
        </table>
      </div>
      
       <!--a href="#" onclick="alert('EM BREVE ESTA FACILIDADE ESTARÁ DISPONÍVEL, \n CONSULTE UM NUCLEO CREDENCIADO DE SUA REGIÃO');return false;" class="botao"><img src="images/botoes/consulta_rgc.jpg"/></a--></div>
