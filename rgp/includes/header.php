...
<img width="87" height="87px" src="./images/icones/LOGONOVAPEDIGREE.png">
  ...
  <div class="header_atendimento" style="position:relative; z-index:3;">
    ...
    <?php if(isset($_SESSION['tel_contato'])){
	if($_SESSION['cidade']=='Cotia'||$_SESSION['cidade']=='Sorocaba')echo '<img src="images/botoes/encontre_nucleo.jpg" onclick="location=\'http://www.megapedigree.com/site/credenciado.php?consultar=%25\';" class="botao">'; else echo $_SESSION['tel_contato']; 
		
	}else echo '+55 (15) 3211-1725<br /> +55 (15) 3232-6601';?><br />
    </div>
    <div>
...
<ul id="jsddm">
    ...
    <div class="menu_box"><a href="quem_somos.php" class="oswald_branco16">QUEM SOMOS</a></div>  
          <ul style="visibility: hidden; width: 175px;">
              ...
              <li><a href="declaracao_pub.php">Comunicados</a></li>                                         
              </ul>    
    </li>
...
<li><a href="rgc.php">R.G PET </a></li>
...
<!--li><a href="http://www.megapedigree.com/site/delivery.php">Delivery</a></li-->
...
<li>    <div class="menu_linha"><img src="images/linhas/linha_sep_menu.png"/></div></li>
<li>    <div class="menu_box"><a href="duvidas.php" class="oswald_branco16">DÚVIDAS</a></div></li>
<!--<li>    <div class="menu_linha"><img src="images/linhas/linha_sep_menu.png"/></div></li>
<li>    <div class="menu_box"><a href="contato.php" class="oswald_branco16">CONTATO</a></div></li>-->

<li>    <div class="menu_linha"><img src="images/linhas/linha_sep_menu.png"/></div></li>
<li>    <div class="menu_box"><a href="http://www.conveniosaudepet.com.br/" target="new" class="oswald_branco16" style="color:#FF6;">CONVÊNIO SAÚDE</a></div></li>
<li>    <div class="menu_linha"><img src="images/linhas/linha_sep_menu.png"/></div></li>
