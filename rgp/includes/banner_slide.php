...
<div class="banner_full" >
 ...
 <iframe src="./banner.php" style="width: 720px;border: 0px;height: 368px;float: left;margin-top: 8px;" frameBorder="0" scrolling="no">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><form action="busca_pedigree.php" method="post">
              <input name="busca_chip" type="text" class="login_forms_consultar" id="consultar" onfocus="if(this.value=='Ex. RG/SP 001') {this.value='';}" onblur="if(this.value=='') {this.value='Ex. RG/SP 001';}" value="Ex. RG/SP 001" />
    ...
    <tr><td class="arial_cinza11">Somente pedigrees a partir de 01.02.2014</td></tr>
       ...
       <div class="banner_consulta"><a href="#" onclick="$('.banner_busca:eq(0)').slideUp(0);$('.banner_busca:eq(1)').slideDown();return false;" class="botao"><img src="images/botoes/consulta_rgc.jpg"/></a>

<div class="banner_busca" style="display:none;margin-top:-1px">
      <div class="margin10">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="oswald_cinza16">CONSULTAR RGC</td>
          </tr>
          <tr>
            <td valign="middle" class="arial_cinza11">Pesquise</td>
          </tr>
          <tr>
            <td><form action="busca_rgc_capa.php" method="post">
              <input name="busca_chip" type="text" class="login_forms_consultar" id="consultar" onfocus="if(this.value=='Ex. 007') {this.value='';}" onblur="if(this.value=='') {this.value='Ex. RG/SP 001';}" value="Ex.121" />
            <input class="botao" type="image" src="images/botoes/buscar.jpg" align="absmiddle" onclick=""/>
	</form></td>
    <tr><td class="arial_cinza11">Somente RGC Sobraci</td></tr>
          </tr>
        </table>
      </div>
    </div>
