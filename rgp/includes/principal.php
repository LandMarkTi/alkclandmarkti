...
while($f=mysql_fetch_assoc($qr)){?>
        ...
        <div style="display:table;width:430px;">
        <a class="botao" href="mailto:adm@sobraci.org"><img src="images/botoes/seja_credenciado.jpg" style="margin-right:12px;margin-left: 0px;"/></a>
