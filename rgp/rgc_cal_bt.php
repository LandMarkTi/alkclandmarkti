...
<H1 style="color:#428F25;opacity:1;font-size: 20px;">Agendamento Banho e Tosa </h1>
<br>

<iframe src="http://rgpetsystem.club/jqx/demos/jqxscheduler/scheduler-localization_pt_tosa.php" scrolling="no" style="border:0" width="490px" height="560px"></iframe>
                </form></div>
