...
$fdata=$edata+7200;
$qc=mysql_query("select * from agendamento where crmv_ag='$linha[crmv]' and hora between $edata AND $fdata");
$nc=mysql_num_rows($qc);

if($nc>1)die('Data ocupada, escolha outra hora');

$sql = "insert into agendamento values ('','$ano-$m-$d',$edata,$_SESSION[cid],'$tipo','$linha[crmv]')";
...
<H1 style="color:#428F25;opacity:1;font-size: 20px;">Agendar Atendimento </h1>
...
Nome do responsável: <br>
		...
		<option>Banho e Tosa</option>
                ...
                <br>
                <input type="hidden" id="id_ped" name="crmv" value="<?=$linha2['crmv_med']; ?>" required>
