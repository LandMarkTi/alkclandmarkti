...
if($busca=='')$sql = "select * from rgc where crmv='".$f_cli['crmv_med']."' order by id asc"; else $sql = "select * from rgc where crmv='".$f_cli['crmv_med']."' and (id='$busca'  or nome like '%".$busca."%' or nome_cao like '%".$busca."%' or rg like '".$busca."%' ) order by id asc"; 
...
<div class="internas_full">
 <div class="internas_margem_full" style="width:100%"> 
 	...
 	<div class="internas_box" style="width:90%;margin-left: 5%;margin-right: 5%;">
...
.mesma{ display:inline-block;width: 25%;height:20px}
...
<br>
<input name="bus" style="width:120px;height: 23px;padding: 4px;margin: 5px;"><input type="submit" style="width:120px;height: 40px;padding: 4px;margin: 5px;">
<br>
...
?>
		<div class="br">
			<div class="mesma <?=$branco?>" style="">
		        ...
		        <?=substr($l['nome_cao'],0,18).'('.$l['tipo'].')'?><a target="_new" href="../ver_carteirinha.php?id=<?=$l['id']?>"><img width="15px" src="http://megapedigree.com/painel_geral_123/images/icons/Note-icon.png"></a> <a target="new" href="imprime_cartao/imprime.php?id=<?=$l['id']?>"><img src="http://megapedigree.com/painel_geral_123/images/icons/print.png"></a>
			<a href="rgc_edit_l.php?c_id=<?=$l['id']?>" style="float:right"> <img src="img/mag-glass.png" width="15px"> </a> <a href="rgc_lista_prontuario_cli.php?cli=<?=$l['id']?>" style="float:right"> <img src="img/cross.png" width="15px"> </a>            
		        </div>
		</div>
<?php $par++;}?>
