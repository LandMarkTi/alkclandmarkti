...
$sql = "select *,DATE_FORMAT(nascimento,'%d/%m/%Y') as nasci from rgc where id = $id";
...
$pdf->Image($file,14.1, 0.8 , 4 , 4,'PNG');
...
$pdf->SetXY(5.7,3.0);
$pdf->SetFont('arial','',9);
$pdf->Cell(5.5, 0.8,iconv('UTF-8', 'windows-1252', $l['crmv']) , 0 , 1 , 'L' );

$pdf->SetXY(8.0,3.4);
$pdf->SetFont('arial','',9);
$pdf->Cell(3.5, 0.8,iconv('UTF-8', 'windows-1252', $l['nasci']) , 0 , 1 , 'L' );


$pdf->SetXY(2.2,3.5);
$pdf->SetFont('arial','',9);
$pdf->Cell(9.5, 0.8,iconv('UTF-8', 'windows-1252', $l['nome_cao']) , 0 , 1 , 'L' );

$pdf->SetXY(2.2,4.0);
$pdf->SetFont('arial','',9);
$pdf->Cell(9.5, 0.8,iconv('UTF-8', 'windows-1252', $l['raca']) , 0 , 1 , 'L' );

$pdf->SetXY(2.2,4.5);
$pdf->SetFont('arial','',9);
$pdf->Cell(9.5, 0.8,iconv('UTF-8', 'windows-1252', $l['sexo']) , 0 , 1 , 'L' );


$pdf->SetXY(1.7,5.0);
$pdf->SetFont('arial','',9);
$pdf->Cell(9.5, 0.8,iconv('UTF-8', 'windows-1252', $l['pai']) , 0 , 1 , 'L' );


$pdf->SetXY(1.9,5.5);
$pdf->SetFont('arial','',9);
$pdf->Cell(9.5, 0.8,iconv('UTF-8', 'windows-1252', $l['mae']) , 0 , 1 , 'L' );


$pdf->SetXY(0.6,6);
$pdf->SetFont('arial','',9);
$pdf->Cell(9.5, 0.8,iconv('UTF-8', 'windows-1252', $l['tipo']) , 0 , 1 , 'L' );
