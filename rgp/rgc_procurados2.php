...
<span style='color:#008000;font-size:14px'><br>RG ".$l['id']."<div style='height: 100px;
display: block;
overflow: hidden;
margin-bottom: -10px;
width: 145px;'><img width='190px' src=\"".$l['foto']."\"></div><br><center style='background-color:white;color:black;width: 180px;'>".$l['tipo'].' '.$l['raca'].' '.$vs[$l['sexo']].'<br>Local: '.substr($l['endereco'],0,15)."<br>".$l['cidade']."-".$l['estado']."</span>
