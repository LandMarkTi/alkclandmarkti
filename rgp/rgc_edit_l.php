...
//print_r($_POST);
$senha=addslashes($_POST['sena']);
if($senha!='')$pass=",ps='".md5($senha)."' ";

$sql = "update rgc set nome='$nome',rg='$rg', cpf='$cpf', endereco='$endereco', bairro='$bairro', cidade='$cidade', estado='$estado', cep='$cep', tel_res='$tel_res', tel_com='$tel_com', celular='$celular', email='$email', nome_cao='$nome_cao', microchip='$microchip', nascimento='$nascimento', raca='$raca', sexo='$sexo', cor='$cor', pai='$pai', mae='$mae', qrcode='$qrcode', crmv='$crmv' $pass  where id = '$id_ped' ";  
...
<H1 style="color:#428F25;opacity:1;font-size: 20px;">Dados do cliente </h1>
...
  Nome da Mãe: 
			...
			Tipo<br>
				...
				CRMV<br>
				<input type="text" name="crmv" id="qrcode2" size="6" value="<?php echo $linha['crmv'];?>" ><br>
	Trocar Senha<br>
				<input type="text" name="sena"  size="16" value="" ><br>
