...
if($qrcode=='050929')die("<script>alert('Qrcode já cadastrado');location='rgc_demo.php';</script>");
...
<div class="internas_full">
 <div class="internas_margem_full">
	...
	<style>#emailForm input{width: 420px}</style><div style="border: 2px solid white;margin: 21px;background-color:whiteSmoke;opacity:0.80;border-radius:20px">
<form method="post" name="emailForm" id="emailForm" enctype="multipart/form-data" style="margin-left: 143px;margin-top: 69px;">
<H1 style="color:#428F25;opacity:1">Formulário RG PET </h1>
