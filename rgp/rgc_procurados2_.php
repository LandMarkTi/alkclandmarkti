...
.PERDIDO {margin: 10px;background-color:green}

.FURTADO {margin: 10px;background-color:yellow}

.ROUBADO {margin: 10px;background-color:red}

.FUGIU {margin: 10px;background-color:aqua}
...
display: block;
padding-bottom: 25px;
margin-bottom: -37px;'>".$l['ocorrencia']."
<span style='color:red;font-size:14px'><br>RG ".$l['id']."<div style='height: 100px;
display: block;
overflow: hidden;
margin-bottom: -10px;'><img width='190px' src=\"".$l['foto']."\"></div><br><center style='background-color:white;color:black;width: 180px;'>".$l['tipo'].' '.$l['raca'].' '.$vs[$l['sexo']].'<br>Local: '.substr($l['endereco'],0,15)."<br>".$l['cidade']."-".$l['estado']."</span>
<a class='".strtoupper($l['ocorrencia'])."' style='display: block;
padding: 10px;
width: 113px;
border-radius: 5px;color:white;text-decoration:none;font-weight: bolder;' href='mailto:".$l['email']."'>INFORMAR</a>
<span style='background-color:white;width: 180px;font-size:14px'><b>OBS:CRIANÇA DOENTE</b></span>
</center>
</div>
";
}
