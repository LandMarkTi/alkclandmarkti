...
<H1 style="color:#428F25;opacity:1;font-size: 27px;">Listar Exames </h1>
<br>
...
<?php }?>
		<input type="hidden" name ="cr" value="<?=$_GET['crmv']?>">
                <input type="submit" value="Novo" style="height: 40px;margin-top:20px" onclick="location='rgc_add_exame.php';return false;" id="enviar">
		<br>
