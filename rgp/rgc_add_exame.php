...
mysql_query("INSERT INTO `rgpet`.`exames` (`id_vac`, `id`, `data_cadastro`, `data_form`,`desc`, `Resp_tec`, `arquivo`, `id_med`) VALUES (NULL, '$id_ped', '$apl', '$revac', '$desc','$med', '$vac', '$crmv');");

die("<script>location='rgc_lista_exames.php'</script>");
...
<H1 style="color:#428F25;opacity:1;font-size: 27px;">Novo Exame </h1>
<br>
RG PET: &nbsp;&nbsp;
...
location='rgc_add_exame.php?crmv='+p;
<?php
