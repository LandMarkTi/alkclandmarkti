...
$sql = "SELECT * FROM med_vet2 WHERE id=$id";
...
.hid{ display:none}
 ...
 #oval { width: 53px; height: 48px;color: white; background: #428F25; -moz-border-radius: 50px / 25px; -webkit-border-radius: 50px / 25px; border-radius: 50px / 25px;padding-left: 42px;display:block;margin-left: 40%; }
...
<H1 style="color:#428F25;opacity:1;font-size: 24px;cursor:pointer;" title="em breve" onclick="location='#'">Gerenciar Créditos </h1>

<H1 style="color:#428F25;opacity:1;font-size: 24px;cursor:pointer;"  onclick="location='rgc_add_promo.php'">Folder promocional </h1>

<!--H1 style="color:#428F25;opacity:1;font-size: 27px;cursor:pointer;" onclick="location='rgc_lista_prontuario.php'">Procedimentos </h1-->

<H1 style="color:#428F25;opacity:1;font-size: 24px;cursor:pointer;" onclick="location='rgc_lista_clientes.php'" >Listar clientes </h1>

<H1 style="color:#428F25;opacity:1;font-size: 24px;cursor:pointer;" onclick="location='rgc_cal_bt.php'">Agendamento banho e tosa </h1>

<H1 style="color:#428F25;opacity:1;font-size: 24px;cursor:pointer;" onclick="location='rgc_cal_v.php'">Agendamento Veterinário  </h1>

<H1 style="color:#428F25;opacity:1;font-size: 24px;cursor:pointer;" onclick="location='rgc_edit_cli.php'">Editar Dados </h1>

<H1 style="color:#428F25;opacity:1;font-size: 24px;cursor:pointer;" onclick="location='rgc_exp.php'">expediente </h1>
...
setTimeout(function(){console.log(window.parent.scrollHeight);},'500');
</script>    
