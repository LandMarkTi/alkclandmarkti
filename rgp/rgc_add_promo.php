...
//move_uploaded_file($fototemp,'../promo/'.$fotonome);
...
die("<script>alert('Arquivo enviado.');location='rgc_menu_clinica.php'</script>");
...
<H1 style="color:#428F25;opacity:1;font-size: 27px;">Nova Promoção </h1>
<br>
<br>
