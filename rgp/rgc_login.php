...
<?php
	...
	?>
<center><a href="mailto:rg@rgpet.club"><img src="img/rec2.png" width="100%"></a></center>
...
<H1 style="color:#428F25;opacity:1;font-size: 27px;">Login RG PET </h1>
<br>
Email: <br>
                <input type="text" name="email" id="nome" size="30" value="" required>
                <br>
                Senha:<br>
                <input type="text" name="senha" id="rg" size="30" value="" >                
                <br> <br>
