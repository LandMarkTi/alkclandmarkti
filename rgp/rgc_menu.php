...
die("<script>location='rgc_login2.php';</script>");
}
$id=$_SESSION['cid'];

$q_l=mysql_query("SELECT * FROM `pedigre_trocados_capa` WHERE id_trans_capa=$id ");
...
<H1 style="color:#6ba9aa;opacity:1;font-size: 27px;cursor:pointer;" onclick="window.open('../site/pedcode.php?id_ped=<?=$dados['id_ped']?>&id_filhote=<?=$dados['id_f']?>')">Abrir Documento </h1>
