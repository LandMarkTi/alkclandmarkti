...
<br>
<a href="#">http://ALKC.org/c/'.$qrcode.'</a>
...
<meta property="og:site_name" content="ALKC - Sociedade Brasileira de Cinofilia Independente - Registro Pedigree Cães - Cachorro - Filhotes" />
...
<H1 style="color:#6ba9aa;opacity:1;font-size: 27px;">Formulário do Veterinário </h1>
<br>
Nome: <br>
...
<br>
               ...
               Cidade:<br>
				...
				<br>
<H1 style="color:#6ba9aa;opacity:1;font-size: 27px;">Dados da Clínica </h1>
		Clinica:<br>
		<input name="tipo" ><br>
