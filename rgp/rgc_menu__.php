...
<H1 style="color:#428F25;opacity:1;font-size: 27px;cursor:pointer;" onclick="location='rgc_tabela_vacinas.php'" >Carteira de vacinação </h1>

<!--H1 style="color:#428F25;opacity:1;font-size: 27px;cursor:pointer;" onclick="location='rgc_lista_exames.php'">Exames </h1-->

<H1 style="color:#428F25;opacity:1;font-size: 27px;cursor:pointer;" onclick="location='rgc_edit.php'">Editar Dados </h1>

<H1 style="color:#428F25;opacity:1;font-size: 27px;cursor:pointer;" onclick="location='rgc_alerta.php'">Alertar como Procurado </h1>
...
<span id="oval">
<p style="font-weight: bold;margin-left: -11px;padding-top: 14px;">Sair</p>
</span>
