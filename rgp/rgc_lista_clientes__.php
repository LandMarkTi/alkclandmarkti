...
if($busca=='')$sql = "select * from rgc where crmv='".$f_cli['crmv_med']."' order by id asc"; else $sql = "select * from rgc where crmv='".$f_cli['crmv_med']."' and (nome like '%".$busca."%' or nome_cao like '%".$busca."%' or rg like '".$busca."%' ) order by id asc"; 
