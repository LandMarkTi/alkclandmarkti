...
<h1 id="confira" style="margin-left: 17%;color:#62a9b3;width: 60%;">Confira os dados do documento abaixo:</h1>
...
<form action="env_trans_pagto_t.php" method="post" class="f1" style="padding-left: 65px;">
			...
			<tr>
    				...
    				<td><input style="width: 80%;" id="cep" name ="cep" type="text" class="forms"  required="required" onblur="$('.adr').show();"/></td>
			  </tr>
			<tr>
			...
			<tr>
	  		...
	  		<tr>
    				...
    				<td><input style="width: 80%;" name ="mic" type="number" value="<?=$mic?>" class="forms" id="ccm"  /></td>
			  </tr>
              
             			  <tr>
    				<td align="right"><label for="sexo" class="arial_cinza2_12" >Documento</label></td>
