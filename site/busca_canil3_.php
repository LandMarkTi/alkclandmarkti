...
.np {width:90%;margin-left: 64px;line-height:}</style>
	<style type="text/css">
@font-face {
 ...
 <img src="images/cert_canil4.jpg" class="np"><br><span style="margin-top: -380px;display: block;margin-left: 239px;font-size: 14px;">
<center style="font-size: 40px;margin-left: -219px">Certificamos o Registro do Afixo do Canil:<br>
'.ucwords(strtolower($canil)).'</center><div style="line-height: 10px;">
