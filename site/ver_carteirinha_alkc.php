...
if (strlen($pai) >= 52) {array_pop($vpai);array_pop($vpai);$pai = implode(' ', $vpai);}

if (strlen($mae) >= 52) {array_pop($vmae);array_pop($vmae);$mae = implode(' ', $vmae);}
...
<span id="CRMV"><?php echo strtoupper($cr);?></span>

<span id="nome"><?php echo strtoupper($nome_cao);?></span>

<span id="nascimento"><?php echo date("d-m-Y", $l['nasc']);?></span>

<span id="raca"><?php echo strtoupper($raca);?></span>

<span id="cor"><?php echo strtoupper(str_replace('Escolha a cor..','',$cor));?></span>

<span id="sexo"><?php if($sexo=='Masc')echo 'MACHO'; else echo 'FEMEA';?></span>
<span id="pai"><?php echo strtoupper($pai);?></span>
<span id="mae"><?php echo strtoupper($mae);?></span>
