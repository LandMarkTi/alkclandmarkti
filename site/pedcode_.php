...
if($l['nome']=='proprietario')$l['py']='46';
...
while($i<=4){
	...
	while($j<pow(2,$i)){
		...
		echo "<div class='noprint' style='position:absolute;left:".$offx."mm;top:".(75.0 +$offy[$i]+((95/pow(2,$i))+0.2)*$j)."mm;width:".$largs[$i]."mm;height:".(95/16)."mm;font-size:$tamanhoInicial'>".strtoupper(str_pad(str_replace('digite o nome..','XXXXXXXXXXXXXXX',str_replace('\n','<br>',array_shift($p))),50,' '))."</div>";
		$j++;
	}
