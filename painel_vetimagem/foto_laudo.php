...
$id_cid=(int)$_SESSION['cid'];


$id_ped=(int)$_POST['id_ped'];
$id_f=(int)$_POST['id_f'];

$res=(int)$_POST['resultado'];
...
mysql_query("insert foto_laudos values('','/painel_criador_alkc/docs/$fotonome','$id_ped','$id_f','$res','$crmv','$desc')")or die('ee');
}
...
mysql_query("INSERT INTO `vet_pedido` VALUES (NULL,$id_ped,$id_f, NOW(), '0', 'vetimagem@alkc.com.br');");
