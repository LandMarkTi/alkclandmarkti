...
$('#pai1').change(function(){$.each(p1,function(i,e){$('input[class=parent]:eq('+p1[i]+')').val('aguarde');});var x=$('#pai1 option:checked').attr('title');var y=this.value;$.get("post_parente_novo.php?id="+y+"&pt=1&rac=<?=$_GET['r']?>", function( data ) { var nom=data.split(',');$('input[class=parent]:eq(0)').val(x);$.each(p1,function(i,e){$('input[class=parent]:eq('+p1[i]+')').val(nom[i]);});}); });

$('#pai1').change(function(){$.each(p2,function(i,e){$('input[class=parent]:eq('+p2[i]+')').val('aguarde');});var x=$('#pai1 option:checked').attr('title');var y=this.value;$.get("post_parente_novo.php?id="+y+"&pt=2&rac=<?=$_GET['r']?>", function( data ) { var nom=data.split(',');$('input[class=parent]:eq(0)').val(x);$.each(p2,function(i,e){$('input[class=parent]:eq('+p2[i]+')').val(nom[i]);});}); });

$('#pai2').change(function(){$.each(p3,function(i,e){$('input[class=parent]:eq('+p3[i]+')').val('aguarde');});var x=$('#pai2 option:checked').attr('title');var y=this.value;$.get("post_parente_novo.php?id="+y+"&pt=1&rac=<?=$_GET['r']?>", function( data ) { var nom=data.split(',');$('input[class=parent]:eq(1)').val(x);$.each(p3,function(i,e){$('input[class=parent]:eq('+p3[i]+')').val(nom[i]);});}); });

$('#pai2').change(function(){$.each(p4,function(i,e){$('input[class=parent]:eq('+p4[i]+')').val('aguarde');});var x=$('#pai2 option:checked').attr('title');var y=this.value;$.get("post_parente_novo.php?id="+y+"&pt=2&rac=<?=$_GET['r']?>", function( data ) { var nom=data.split(',');$('input[class=parent]:eq(1)').val(x);$.each(p4,function(i,e){$('input[class=parent]:eq('+p4[i]+')').val(nom[i]);});}); });
