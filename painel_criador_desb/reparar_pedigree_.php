 ...
 <div id="internas_margem_full">
	...
	<input class="parent" name="p[]"><br><input class="parent" name="p[]">
              ...
              <tr>
                <td align="right">&nbsp;</td>
                <td class="opts">
                <a href="#" class="button" onclick="return false;">Pagar Pedigree sem foto</a> <a href="#" class="button" onclick="$('#fot').click();">Pagar Pedigree com foto</a> <a class="button" href="print_Pedigree.php?id=<?php echo $_GET['id'];?>">Visualizar</a>
                </td>            
              </tr>
...
<input type="hidden" name="itemAmount1" id="valor_produtos"  value="1.50"/>
...
$("#lab-cor").remove();
$("#td-cor").remove();
$('.opts a:eq(0)').click(function(){var x=$('#meuid').val();$('#meuid').val(x+$('input[name=pd]:checked').val());$('#pagseguro2').submit();return false;});
