 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
        ...
        <tr>
    				...
    				<td><select name="cor" id="cor" class="forms">
				<option>selecione Uma Raça</option>
				</select></td>
			  </tr>
              <tr>
              ...
              <tr style="display:none;">
    				...
    				<td><input name="registro" type="text" class="forms"  value="<?php echo 'SP01-'.mt_rand(1000, 10000);;?>" size="65" /></td>
			  </tr>
              ...
              <tr>
				...
				<div class="wrappern">
				  ...
				  <div class="ng22">
					<br> <input value="Nome Filhote" name="n[]" size="13"><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span><br><br> <input value="Nome Filhote" name="n[]" size="13"><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span>
				  </div>
				  <div class="ng23">
					<br> <input value="Nome Filhote" name="n[]" size="13"><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span><br><br> <input value="Nome Filhote" name="n[]" size="13"><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span>
				  </div>
