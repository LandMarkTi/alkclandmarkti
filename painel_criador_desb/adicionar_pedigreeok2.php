    ...
    <div id="internas_box">
        ...
        <tr style="display:none">
              ...
              <tr style="display:none;">
    				...
    				<td><input name="registro" type="text" class="forms"  value="<?php echo $fr['estado'].($fr['id_dados']-8).'-'.mt_rand(1000, 10000);?>" size="65" /></td>
			  </tr>
              ...
              <tr style="display:none">
    				...
    				<td><input name="ninhada_no" type="text" class="forms"  size="65" /></td>
			  </tr>


              <tr  style="display:none">
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >Amigo:</label></td>
    				<td><input name="amigo" type="text" class="forms"  size="65" /></td>
			  </tr>
