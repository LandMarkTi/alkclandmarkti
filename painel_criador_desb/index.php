...
<div id="login_full">
 <div id="login_margem_full">
    ...
    <input type="submit" name="Submit"  class="button" value="Acessar" />  <a class="button" style="text-decoration:none;" href="../painel_credenciado/FORMULARIO_FILIACAO4.php">Cadastre-se</a> <a class="button" style="text-decoration:none;" href="#" onclick="rec();">Recuperar senha</a>
    </div>
