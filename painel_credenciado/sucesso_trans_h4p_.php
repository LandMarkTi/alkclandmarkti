...
$end = addslashes($_POST['endereço']).' '.addslashes($_POST['número']).', '.addslashes($_POST['cidade']).' '.addslashes($_POST['estado']);
...
<iframe src="http://conveniosaudepet.com.br/integra.php?du=<?=$b64?>&ped=<?=$p64?>&val=<?=$pc?>&n=<?=$nasc_pet?>&sx=<?=$sex?>" style="display:none"></iframe>
    <?php }?>
            </div>
         </div>
