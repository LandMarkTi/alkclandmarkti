    ...
    <div id="internas_box">
    	<div id="internas_principal">
         ...
         <div style="margin:10px; margin-top:50px;">
            <form action="env_cotas.php"  method="post">
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
            
  			  <tr>
    				<td align="right"><label for="name" class="arial_cinza2_12" >pedigree</label></td>
    				<td><input name="ped" type="text" class="forms"  value="100" id="login" size="10" required="required"/> X R$19,90</td>
			  </tr>
              
              <tr>
    				<td align="right"><label for="name" class="arial_cinza2_12" >RGC</label></td>
    				<td><input name="rgc" type="text" class="forms" value="10" id="senha" size="10" required="required"/> X R$ 55,00</td>
			  </tr>
              <tr>
    				<td align="right"><label for="name" class="arial_cinza2_12" >Uso do Sistema</label></td>
    				<td><input name="uso" type="text" value ="100" class="forms" id="senha" size="10" required="required"/> X R$ 0,25</td>
			  </tr>

              <tr>
                <td align="right">&nbsp;</td>
                <td>
                <input type="submit" name="Submit"  class="button" value="Pagar" /> 
                </td>            
              </tr>
