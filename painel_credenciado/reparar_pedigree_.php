 ...
 <div id="internas_margem_full">
	...
	<input class="parent" name="p[]"><br><input class="parent" name="p[]">
              ...
              <tr>
                <td align="right" >&nbsp;</td>
                <td id="lista_ped">
                <input type="submit" name="Submit"  class="button" value="imprimir" style="height: 50px;width: 102px;position: relative;left: 250px;top: 100px;background-color: rgb(112, 158, 94);font-size: 14px;color: white;"/> 
                </td>            
              </tr>
...
$('#lista_ped').append('<br>');
$('#td-ninhada input').each(function(i,x){
if(i>3)$('#lista_ped').append(listan[i]+'<input type="checkbox" name="pgs[]" value="'+i+'"><br>');
});
