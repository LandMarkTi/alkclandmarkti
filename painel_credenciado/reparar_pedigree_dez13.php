...
<div id="internas_full">
 <div id="internas_margem_full">
	...
	<input class="parent" name="p[]"><br><input class="parent" name="p[]">
		...
		<tr>
		<td><?php 
$sql_fot="SELECT * FROM  `foto_ped` where id_ped=".$_GET['id']." ORDER BY id_foto DESC";
$qrf=mysql_query($sql_fot);
$lin=mysql_fetch_assoc($qrf);
$nnn=mysql_num_rows($qrf);
if($nnn>=1)echo '<img src="./images/pedigree/'.$lin['arquivo'].'" style="max-width:70px;">'; else echo'sem foto';
?></td><td ><iframe src="up_foto.php?id_foto=<?php echo $_GET['id'];?>" frameborder="0" border="0" ></iframe></td>
              </tr>
              <tr>
                <td align="right" >&nbsp;</td>
                <td id="lista_ped">
...
$.post('cotas_filhote.php',{i:i,id:<?php echo $id;?>},function(data){mydata=data;$('#lista_ped').append(listan[i]+'-'+mydata+'ª via <input type="checkbox" name="pgs[]" value="'+i+'"><br>');});
