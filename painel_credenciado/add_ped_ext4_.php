...
<form title="sucesso_pedigree_ext_sbc.php" method="post" onsubmit="return false;" id="tform" class="pedform" enctype="multipart/form-data">
...
<script>
function mandar(){
var jqxhr = $.post( "sucesso_pedigree_ext_sbc.php",$( "#tform" ).serialize(), function() {
  alert( "pedigree enviado!" );
