...
?>
        <tr>
			...
			<?php if($_SESSION['login']=='nucleosorocaba@sobraci.org'||$_SESSION['login']=='delivery@sobraci.org'){?><a href="print_ped.php?id=<?=$linha['id_ped']?>&pgs=<? echo ($cf);?>"><img style="max-width:20px" src="http://www.megapedigree.com/painel_geral_123/images/icons/printer.png"></a></td><?php }?>
        </tr>
       <?php 	}}} ?>
      </tbody>
    </table>
