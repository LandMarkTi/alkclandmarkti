...
<div id="principal_full">
 <div id="principal_margem_full">
	...
	<div id="principal_resumo_site" style="width: 750px;height: 250px;border-color: #487F42;">
        <div class="arial_branco12" id="principal_titulo" style="background-color: #487F42;">Painel de controle</div>
