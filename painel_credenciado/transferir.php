...
<div id="internas_full">
 <div id="internas_margem_full">
   ...
   <form method="post" action="#" id="frm-filtro">
	...
	<tr>
		        <td height="25" align="center" style="font: 14px Verdana,Arial;"><a style="color:green;font-size:18px;text-decoration:none;border-radius: 5px;padding: 4px;background-color: lightgray;" href="listagem_transf.php">Listar Transferências</a></td><!-- transferir_lista.php -->
		        <td></td>
			  </tr>
