   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo"><?php if($usr!=0)echo 'Histórico do Usuário '.$usr;else echo 'Entrada';?>       
      ...
      <thead>
        <tr>
		  ...
		  <th width="34">Id</th>
		  <th width="250">Nome User</th><th>data</th>
          <th width="132">email</th>
          <th width="50">valor</th>
	<th width="50">aposta</th>
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
		        ...
		        <td><?php echo $linha['nome'].' '.$linha['sobrenome']; ?></td><td><?php echo date("d/m/Y",$linha['dataPagto']);?></td>
                <td><?php echo $linha['email']; ?> </td>
                <td><?php echo money_format("%!0.2n",$linha['valorPagto']*0.01); ?></td>
		<td><?php echo $linha['id_ap'];?></td>
      ...
      $("table") 
        ...
        .bind('sortEnd', function(){
          ...
          $('table > tbody > tr:odd').addClass('odd');
           ...
           </form><a href="log_user.php" style="position:relative;left:300px;">Baixar como arquivo</a><br><br><br><br>
         </div>
