...
$q_cota=mysql_query("INSERT INTO `cotas` (`id_cota`, `id_cred`, `v_ped`, `v_rgc`, `v_sistema`, `data_pedido`, `data_apr`) VALUES (NULL, '$id_meu', '$pedigree', '$rgc', '$sis', '$data', '0000-00-00');");
...
$envio = mail('adm@sobraci.org', "Adicionar Cota", "$ht", $headers,"-rcontato@megapedigree.com");
