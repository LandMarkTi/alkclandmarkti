...
$id=$_GET['id'];
$sql1="select * from pedigree join subcategoria on pedigree.id_raca=subcategoria.idSubcategoria LEFT JOIN pedigre_trocados USING ( id_ped ) where id_ped=".$id;
$qr=mysql_query($sql1);
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
                           ...
                           <?php foreach($linha_ped as $k=>$v){ if($l>1&&$l<20){?>
              <tr>
    				<td align="right" ><label for="subcategoria" class="arial_cinza2_12" id="lab-<?php echo $k;?>"><?php echo $k;?></label></td>
    				<td id="td-<?php echo $k;?>"><input name="subcategoria" type="text" class="forms" id="subcategoria" size="65" required value="<?php echo $v;?>"/></td>
			  </tr>
		<?php }$l++;}?>
	...
	<input class="parent" name="p[]"><br><input class="parent" name="p[]">
              ...
              <tr>
                <td align="right" >&nbsp;</td>
                <td id="lista_ped">
                <input type="submit" name="Submit"  class="button" value="imprimir" style="height: 50px;width: 102px;position: relative;left: 250px;top: 40px;background-color: rgb(112, 158, 94);font-size: 14px;color: white;"/> 
                </td>            
              </tr>
...
$('#td-ninhada').html("<div class=\"wrappern\">                   <div class=\"nwp1\">                <div class=\"ng11\"><center style=\"color:white;padding-top:10px\">Ninhada</center>                </div>                <div class=\"ng12\"><center style=\"color:white;font-size:14px;padding-top: 11px;\">Nascidos<hr>M | F</center>                </div>                <div class=\"ng13\" >                 &nbsp;&nbsp;&nbsp;<input name=\"n[]\" size=\"1\" value=\" 0\" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input  name=\"n[]\" size=\"1\" value=\" 0\" >                </div>                <div class=\"ng14\">                 <center style=\"color:white;font-size:14px;padding-top: 11px;\">Nascidos<hr>M | F</center>                </div>                <div class=\"ng15\">                 &nbsp;&nbsp;&nbsp;<input size=\"1\" name=\"n[]\" value=\" 0\" style=\"padding-top:10px;margin-top:8px\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input size=\"1\" name=\"n[]\" value=\" 0\" style=\"padding-top:10px;margin-top:8px\">                </div>                   </div>                   <div class=\"nwp2\">                <div class=\"ng21\">                </div>                <div class=\"ng22\">                 <br> <input name=\"n[]\" size=\"13\"><br><br> <input name=\"n[]\" size=\"13\">                </div>                <div class=\"ng23\">                 <br> <input name=\"n[]\" size=\"13\"><br><br> <input name=\"n[]\" size=\"13\">                </div>                   </div>                   <div class=\"nwp3\">                <div class=\"ng31\">                 <center style=\"color:white\">Nascidos na <br> Ninhada</center>                </div>                <div class=\"ng32\">                 <br> <input name=\"n[]\" size=\"13\"><br><br> <input  name=\"n[]\" size=\"13\">                </div>                <div class=\"ng33\">                 <br> <input name=\"n[]\" size=\"13\"><br><br> <input name=\"n[]\" size=\"13\">                </div>                   </div>                   <div class=\"nwp4\">                <div class=\"ng41\">                </div>                <div class=\"ng42\">                 <br> <input name=\"n[]\" size=\"13\"><br><br> <input name=\"n[]\" size=\"13\">                </div>                <div class=\"ng43\">                 <br> <input name=\"n[]\" size=\"13\"><br><br> <input name=\"n[]\" size=\"13\">                </div>                   </div>                   <div class=\"nwp5\">                <div class=\"ng51\">                </div>                <div class=\"ng52\">                 <br> <input name=\"n[]\" size=\"13\"><br><br> <input name=\"n[]\" size=\"13\">                </div>                <div class=\"ng53\">                 <br> <input name=\"n[]\" size=\"13\"><br><br> <input name=\"n[]\" size=\"13\">                </div>                   </div>               </div> ");
...
//ajax por filhote
var mydata;
if(i>3&&listan[i]!='Nome Filhote'){
$.post('cotas_filhote.php',{i:i,id:<?php echo $id;?>},function(data){mydata=data;});
$('#lista_ped').append(listan[i]+'-'+mydata+'ª via <input type="checkbox" name="pgs[]" value="'+i+'"><br>');
