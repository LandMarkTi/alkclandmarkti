...
<form action="<?php if($_SESSION['id']==17)echo 'sucesso_pedigree_direto.php'; else echo 'sucesso_pedigree.php';?>" method="post" class="pedform" enctype="multipart/form-data">
    ...
    <div id="internas_box">
        ...
        <tr style="display:none">
              ...
              <tr style="display:none;">
    				...
    				<td><input name="registro" type="text" class="forms"  value="<?php echo 'RI'.$_SESSION['id'].'-'.mt_rand(32000, 35000);?>" size="65" /></td>
			  </tr>
              ...
              <tr  style="display:none">
    				...
    				<td><input name="amigo" type="text" class="forms"  size="65" value="<?=$rg;?>" /></td>
			  </tr>
              ...
              <tr>
    				...
    				<td><input name="proprietario" readonly type="text" class="forms"  size="65" value="<?php echo $linhadono['nome'];?>" required/></td>
			  </tr>


              <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >Endereço:</label></td>
    				<td><input name="endereço" readonly type="text" class="forms"  size="65" value="<?php echo $linhadono['endereco'].' '.$linhadono['bairro'].' '.$linhadono['cidade'].'-'.$linhadono['estado'];?>" /></td>
			  </tr>
...
<script>
$('input[size="13"]:eq(0)').click(function(){
...
$('input[size="13"]:eq(0)').blur(function(){

	if($(this).val()==''){alert('um campo ficou em branco');}

});

$('input[size="13"]:gt(0)').attr('readonly','readonly');
...
$('input[class=parent]').each(function(i,e){$(e).attr('readonly','readonly').css('color','#828282');});
