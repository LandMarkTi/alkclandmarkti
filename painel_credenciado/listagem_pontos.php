...
$sql = "SELECT * FROM pontos ORDER BY id_pontos DESC ";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from pontos";
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Tabela de pontos          
      ...
      <thead>
        <tr>
		  ...
		  <th width="34">Id</th>
		  <th width="356">tipo de Ponto</th>
          <th width="132">valor</th>
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
		        ...
		        <td height="25" align="center"><?php echo $linha['id_pontos']; ?></td>
		        <td><?php echo $linha['nome_ponto']; ?></td>
                <td><?php echo $linha['qtd']; ?></td>
                <td><?php echo date("d-m-Y",$linha['data']); ?></td>
		        <td valign="middle"><a href="reparar_bonus.php?id=<?php echo $linha['id_pontos']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
