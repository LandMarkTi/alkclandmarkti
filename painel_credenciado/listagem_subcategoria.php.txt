   ...
   <form method="post" action="#" id="frm-filtro">
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
		        ...
		        <td valign="middle"><a href="reparar_subcategoria.php?id=<?php echo $linha['idSubcategoria']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> <a href="#" id="yesno<?php echo $linha['idSubcategoria']; ?>"><img src="images/icons/excluir.png" title="Excluir" alt="Excluir" border="0" onClick="ConfirmaExclusao(<?php echo $linha['idSubcategoria']; ?>);"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
