...
$qcr=mysql_query('SELECT * FROM  criadores  where id_criador in (select id_criador from aprovados where 1)  and id_credenciado='.$_SESSION['id'].' ');
...
<form  method="post" onsubmit="return false;" id="tform" class="pedform" enctype="multipart/form-data">
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo" style="color:white" onclick="mandar();">Pedigree Sobraci
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
             <tr><td class="arial_cinza2_12">Imagem do documento</td><td><input type="file" name="foto" required></td>
			  </tr>
		 <tr><td class="arial_cinza2_12" colspan="2"><b style="font-weight: bold;">Adicione somente o Documento escaneado, fotos não serão aceitas e o pedigree será cancelado</b></td>
			  </tr>
        ...
        <tr style="display:none">
              ...
              <tr>
    				<td align="right"><label for="criador" class="arial_cinza2_12" >criador:</label></td>
...
<a id="eml" href="mailto:adm@sobraci.org?subject=copia%20do%20documento%20anterior&body=Envie o comprovante do documento anexado neste email" style="display:none"></a>
<script>
...
<script>
function mandar(){
var jqxhr = $.post( "<?php if($_SESSION['id']==17)echo 'sucesso_pedigree_ext_sbc_direto.php'; else echo 'sucesso_pedigree_ext_sbc.php';?>",$( "#tform" ).serialize(), function() {
  alert( "pedigree enviado para aprovação!" );
	//$('#eml').click();
	location='index_principal.php';
	//location='mailto:adm@sobraci.org?subject=copia+do+documento+anterior&body=Envie+o+comprovante+do+documento+anexado+neste+email';
})
  .done(function() {
