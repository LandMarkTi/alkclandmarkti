...
<form title="sucesso_pedigree_ext_outra.php" method="post" class="pedform" onsubmit="return false;" id="tform"  enctype="multipart/form-data">
...
<script>
function mandar(){
var jqxhr = $.post( "sucesso_pedigree_ext_ou.php",$( "#tform" ).serialize(), function() {
