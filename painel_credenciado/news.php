...
$tit=$_POST['titulo'];
$bloco=$_POST['bloco'];
mysql_query("update textos_site set titulo='$tit' ,bloco='$bloco' where pg='N' ")or die(mysql_error());


}

$dados=mysql_query("select * from textos_site where pg='N'")or die();
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Nova News 
