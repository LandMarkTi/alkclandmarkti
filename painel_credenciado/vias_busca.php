...
<div id="internas_full">
 <div id="internas_margem_full">
   ...
   <form method="post" action="listagem_vias.php" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Buscar Vias do Pedigree          
         ...
         <div>
         <form id="frm_resultados" action="listagem_vias.php" method="get" name="opts">
