...
Nº de série : <input value="" name="serie" placeholder="ex:000000" maxlength="6" required>
              ...
              <tr>
                <td align="left" >&nbsp;</td>
                <td id="lista_ped">
                <input type="submit" name="Submit"  class="button" value="imprimir" style="height: 50px;width: 102px;position: relative;left: 250px;top: -60px;background-color: rgb(112, 158, 94);font-size: 14px;color: white;"/> 
                </td>            
              </tr>
