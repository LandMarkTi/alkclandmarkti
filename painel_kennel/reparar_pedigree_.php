...
if($nt>0)$sql1="select * from pedigree join subcategoria on pedigree.id_raca=subcategoria.idSubcategoria   where id_ped=".$id;
...
Nº de série : <input value="" name="serie" placeholder="ex:000000" maxlength="6" required>
              ...
              <tr>
                <td align="left" >&nbsp;</td>
                <td id="lista_ped"><?=$tr;?>
                <input type="submit" name="Submit"  class="button" value="imprimir" style="height: 50px;width: 102px;position: relative;left: 250px;top: -60px;background-color: rgb(48, 133, 154);font-size: 14px;color: white;"/> 
                </td>            
              </tr>
