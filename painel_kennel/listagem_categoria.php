...
$total="select count(*) from categoria";
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Lista dos Grupos          
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
				<td height="25" align="center"><input type="checkbox" value="<?php echo $linha['idCategoria']; ?>" name="marcar[]" class="cinput" /></td>
		        <td height="25" align="center"><?php echo $linha['idCategoria']; ?></td>
		        <td><?php echo $linha['nomeCategoria']; ?></td>
		        <td valign="middle"><a href="reparar_categoria.php?id=<?php echo $linha['idCategoria']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> <a href="#" id="yesno<?php echo $linha['idCategoria']; ?>"><img src="images/icons/excluir.png" title="Excluir" alt="Excluir" border="0" onClick="ConfirmaExclusao(<?php echo $linha['idCategoria']; ?>);"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
