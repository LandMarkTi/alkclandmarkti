   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Lista dos n&iacute;veis          
          ...
          <div style="float:right; margin-right:10px;"><a class="botao" href="cadastrar_nivel.php"><img src="images/botoes/novo.png" border="0" title="Cadastrar Novo"></a></div>
          </div>
         <div>
      ...
      <thead>
        <tr>
		  ...
		  <th width="34">Id</th>
		  <th width="256">Nome N&iacute;vel</th>
          <th width="132">Pontuação</th>
          <th width="110">Comissão</th>
	<th width="110">Iniciante</th>
		  <th width="72">-</th>
        </tr>
      </thead>
      <tbody>
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
                ...
                <td><?php echo ($linha['comm']*0.01); ?>%</td>
		<td><input type="checkbox" class ="useless"></td>
		        <td valign="middle"> <a href="#" id="yesno<?php echo $linha['id']; ?>"><img src="images/icons/excluir.png" title="Excluir" alt="Excluir" border="0" onClick="ConfirmaExclusao(<?php echo $linha['id']; ?>);"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
