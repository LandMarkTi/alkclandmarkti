...
<div id="login_full">
 <div id="login_margem_full">
    ...
    <div id="login_box" style="border : 1px solid #2b94a7">
     <div class="arial_branco12" id="login_titulo" style="background-color:#2b94a7">Acesso ao Sistema <?php if (getenv('ENV') == 'development') { echo ':: DEVELOPMENT';} else if ($_SERVER["SERVER_NAME"] == 'homologacao.megapedigree.com') { echo ':: HOMOLOGACAO'; } ?></div>
