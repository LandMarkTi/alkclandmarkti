   ...
   <form method="post" action="#" id="frm-filtro">
      ...
      <?php  while($linha = mysql_fetch_array($query)) { $nin=explode(';',$linha['ninhada']);?>
        <tr>
			...
			<a href="print_form.php?id=<?=$linha['id_ped']?>&pgs=<?=$linha['i_filhote']?>"><img style="max-width:20px" src="http://www.megapedigree.com/painel_geral_123/images/icons/printer.png" title="imprimir"></a>			
			</td>
        </tr>
       <?php } 
	?>
