...
if($ttl>1593999995)die('<p> </p><script>location="index_principal.php";</script>');
...
$t_query=mysql_query("select * from ped_serie_a where numero_serie='$str_serie' and status='usado' and tipo_serie='0' and id_credenciado='$idc' ") or die('err_pedserie');
$nt=(int)mysql_num_rows($t_query);

$t_query2=mysql_query("select * from ped_serie_a where numero_serie='$str_serie' and status='livre' and tipo_serie='0' and id_credenciado='$idc' ") or die('err_pedserie2');
...
$fileqr = 'temp/qrtest'.$id.$pgs[0].'.png';
if(is_file($fileqr)==TRUE)$pdf->Image($fileqr,242,48,25,25,'PNG');
