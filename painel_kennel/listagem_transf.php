...
if(isset($_GET['rac']) && $_GET['rac']!='-')$and.=" and id_raca = '$rac' ";$bs.="&rac=".$_GET['rac'];
...
if(isset($_GET['di']) && $_GET['di']!=''){$bs.="&di=$_GET[di]&df=$_GET[df]";$and.=" and emissao BETWEEN ".$di.' and '.$df." ";}
...
?>
        <tr>
			...
			<a href="reparar_pedigree.php?id=<?=$linha['id_ped']?>&f=<?=($i-4)?>"><img style="max-width:20px" src="http://www.megapedigree.com/painel_geral_123/images/icons/printer.png"></a></td>
                </td>
        </tr>
 <?php 
	}
