...
if($livre>=1&&$nt<1){
 ...
 $upp=mysql_query("update ped_serie_cert set status='usado',id_ped='1',id_filhote='1',data_add='".time()."' where numero_serie='$str_serie' and id_credenciado='$ssid' and tipo_serie='1'") or die('opaa');
