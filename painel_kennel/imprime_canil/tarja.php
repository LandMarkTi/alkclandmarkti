...
$query1 = "select * from ped_serie_a where numero_serie='$str_serie' and status='usado' and tipo_serie='3' and id_credenciado='$idc' ";
$query2 = "select * from ped_serie_a where numero_serie='$str_serie' and status='livre' and tipo_serie='3' and id_credenciado='$idc' ";
...
if(is_file($filename)==TRUE)$pdf->Image($filename,14.5, 1.3 , 3 , 3,'PNG');//$pdf->Image('qr.png',14.5, 1.3 , 3 , 3,'PNG');
...
$pdf->SetFont('arial','',8);
$pdf->Cell(9.5, 0.8,iconv('UTF-8', 'windows-1252', mb_strtoupper($raca.' '.$var, 'UTF-8')) , 0 , 1 , 'L' );
...
$pdf->SetFont('arial','',8);
$pdf->Cell(9.5, 0.8,iconv('UTF-8', 'windows-1252', mb_strtoupper($titular,"UTF-8")) , 0 , 1 , 'L' );
