...
$nome_cao=trim(substr($pref.$nome.$sulf,0,45));
...
$pdf->SetFont('arial','',8);
$pdf->Cell(9.5, 0.8,iconv('UTF-8', 'windows-1252', strtoupper(trim(substr($nome_cao,0,50)))) , 0 , 1 , 'L' );

$pdf->SetXY(2.0,(4.0+$yy));
$pdf->SetFont('arial','',8);
$pdf->Cell(9.5, 0.8,iconv('UTF-8', 'windows-1252', strtoupper(trim($raca.' '.$var))) , 0 , 1 , 'L' );
