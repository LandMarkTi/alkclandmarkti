   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Buscar Registro - Transferência         
         ...
         <div>
         <form id="frm_resultados" action="transferir_busca.php" method="get" name="opts">
      ...
      <tbody>
        ...
        <tr>
		        <td height="25" align="center" style="font: 14px Verdana,Arial;">Digite o Registro:</td>
		        <td><input name=bus placeholder="ex: SAO99-999999"><input type=submit></td>
			  </tr>
	<tr>
		        <td height="25" align="center" style="font: 14px Verdana,Arial;"><a style="color:#30859a;font-size:18px;text-decoration:none;border-radius: 5px;padding: 4px;background-color: lightgray;" href="listagem_transf.php">Listar Transferências</a></td><!-- transferir_lista.php -->
		        <td></td>
			  </tr>
