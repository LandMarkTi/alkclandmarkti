...
$sql = "SELECT * FROM usuario where id= 16 ";
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Tabela do site          
      ...
      <tbody>
        ...
        <tr>
		        ...
		        <td valign="middle"><a href="reparar_comissao.php?id=<?php echo $linha['id']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a></td>
        </tr>
       <?php  ?>
      </tbody>
    </table>
