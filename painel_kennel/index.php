...
<script	  src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"	  integrity="sha256-ZosEbRLbNQzLpnKIkEdrPv7lOy9C27hHQ+Xp8a4MxAQ="
...
function Logar(){
	var email = $("#email").val();
	var senha = $("#senha").val();
	$.post("env_login_sl.php",{email: email,senha: senha},function(retorno){
			//alert(retorno);
			if(retorno == 1){
