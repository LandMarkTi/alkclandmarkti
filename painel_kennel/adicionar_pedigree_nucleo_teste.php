...
<form action="<?php if($_SESSION['id']==17)echo 'sucesso_pedigree_direto.php'; else echo 'sucesso_pedigree_ri.php';?>" method="post" class="pedform" enctype="multipart/form-data">
    ...
    <div id="internas_box">
        ...
        <tr style="display:none">
              ...
              <tr>
    				...
    				<td><input name="endereço"  type="text" class="forms"  size="65" value="" /></td>
			  </tr>
