   ...
   <div class="arial_cinza2_14" style="float:right; margin-top:8px; margin-left:4px; width:auto;"><!--span class="arial_cinza2_14" style="font-weight:bold;"><?php echo $nn; ?></span--></div>
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
			...
			<a href="#" title="imprimir" onclick="var tm=prompt('Digite a Série:');window.open('./imprime_canil/imprime_s.php?usr=<?php echo $linha['id_criador']; ?>&serie='+tm);"><img width="16px" height="16px" src="images/icons/print.png"></a>
