...
$tit=$_POST['titulo'];
$bloco=$_POST['bloco'];
mysql_query("update textos_site set titulo='$tit' ,bloco='$bloco' where pg='NB' ")or die(mysql_error());


}

$dados=mysql_query("select * from textos_site where pg='NB'")or die();
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Novo Termo 
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
  			  ...
  			  <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >Texto nova aposta Subcategoria:</label></td>
    				<td><input name="titulo" value="<?php echo $linha['titulo'];?>" type="text" class="forms" id="tituloAposta" size="85" required="required"/></td>
			  </tr>
