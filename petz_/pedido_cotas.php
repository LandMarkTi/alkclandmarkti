         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
  			  ...
  			  <tr>
    				...
    				<td><input name="ped" type="text" class="forms"  value="100" id="login" size="10" required="required"/> </td>
			  </tr>
              
              <tr>
    				<td align="right"><label for="name" class="arial_cinza2_12" >RGC</label></td>
    				<td><input name="rgc" type="text" class="forms" value="10" id="senha" size="10" required="required"/> </td>
			  </tr>
              <tr>
    				<td align="right"><label for="name" class="arial_cinza2_12" >Uso do Sistema</label></td>
    				<td><input name="uso" type="text" value ="100" class="forms" id="senha" size="10" required="required"/> </td>
			  </tr>
