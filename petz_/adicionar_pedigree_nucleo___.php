    ...
    <div id="internas_box">
        ...
        <tr style="display:none">
              ...
              <tr style="display:none;">
    				...
    				<td><input name="registro" type="text" class="forms"  value="<?php echo 'RI'.$_SESSION['id'].'-'.mt_rand(306000, 320000);?>" size="65" /></td>
			  </tr>
              ...
              <tr>
				...
				while($fcr=mysql_fetch_assoc($qcr)){
					echo '<option value="'.$fcr['id_criador'].'">'.$fcr['nome'].' '.$fcr['sobrenome'].'</option>';
				}
				?></select></td>
			  </tr>
              <tr>
