...
<div id="menu_esquerdo_box">
    ...
    <a class="botao" href="listagem_pedigree.php"><img src="images/botoes/listar_pedigree_mp.png" /></a>
    ...
    <a class="botao" href="registro_inicial.php"><img src="images/botoes/registro_mp.png" /></a>
    <a class="botao" href="add_ped_ext.php"><img src="images/botoes/importar.png" /></a>
</div>
