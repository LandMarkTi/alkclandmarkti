...
<br>
Para concluir o processo, entre em contato com o lojista.
<br><br>
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo" style="color:white">Cadastrar Venda  
...
<input type="hidden" name="id_ped" value="<?=$id_ped;?>"> <input type="hidden" name="id_f" value="<?=$id_f;?>">
              ...
              <tr>
    				...
    				<td><input name="canil"  type="text" class="forms"  size="65" value="<?=$linha_criador['nome'];?>" required/></td>
			  </tr>
              ...
              <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >Valor sugerido:</label></td>
    				<td><input name="valor"  type="text" class="forms"  size="65"  value="<?=$linhaped['preco'];?>"/></td>
			  </tr>
              

              <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >Dados da fatura:</label></td>
    				<td><textarea name="loja" cols="70">
