...
?></td><td ><iframe src="up_foto.php?id_foto=<?php echo $_GET['id'];?>&f=<?php echo $_GET['f'];?>" frameborder="0" border="0" ></iframe></td>
              </tr>
              <tr>
                <td align="right" >&nbsp;</td>
                <td id="lista_ped">
...
$.post('cotas_filhote.php',{i:<?php echo ($_GET['f']+4);?>,id:<?php echo $id;?>},function(data){mydata=data;$('#lista_ped').append(listan[<?php echo ($_GET['f']+4);?>]+'-'+mydata+'ª via <input type="checkbox" name="pgs[]" value="'+<?php echo ($_GET['f']+4);?>+'"><br>');});
