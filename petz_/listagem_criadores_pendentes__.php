...
<div id="internas_full">
 <div id="internas_margem_full">
   ...
   <div class="arial_cinza2_14" style="float:right; margin-top:8px; margin-left:4px; width:auto;">Total de registros: <span class="arial_cinza2_14" style="font-weight:bold;"><?php echo $total; ?></span></div>
   <form method="post" action="#" id="frm-filtro">
      ...
      <thead>
        <tr>
          ...
          <th width="344">endereço</th>
          <?php if($_SESSION['login']=='nucleosorocaba@sobraci.org'){?><th width="144">Aprovar</th><?php }?>
	<th>Pago</th>
	<th width="72">Opções</th>
      ...
      <?php  while($linha = mysql_fetch_array($query)) { ?>
        <tr>
                ...
                <td><?php echo $linha['em']; ?></td>
                <td> <?php echo $linha['End_residencial'];?></td>
                
                <td><?php if($_SESSION['login']=='nucleosorocaba@sobraci.org'){?><a onclick="$.post('aprova.php',{id:<?php echo $linha['idc'];?>},function(){location.reload();});"><img width="15px" height="15px" src="images/icons/maximizar.png" ></a><?php }?></td>
