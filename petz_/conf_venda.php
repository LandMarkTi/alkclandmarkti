...
mysql_query("insert into ped_vendas values('',$_POST[id_ped],$_POST[id_f],".time().",".$_SESSION['id'].")");
...
<input type="hidden" name="id_ped" value="<?=$id_ped;?>"> <input type="hidden" name="id_f" value="<?=$id_f;?>">
              ...
              <tr>
				...
				$qr_loja=mysql_query('select * from lojas where id_loja='.$_SESSION['id']);
				$linha_loja=mysql_fetch_assoc($qr_loja);
				echo $linha_loja['razao_social'].'<br><br>Telefone'.$linha_loja['telefone'].'<br><br>'." endereço:<br>".$linha_loja['endereço'].'<br><br>CNPJ :'.$linha_loja['cnpj'];
				?>
				</textarea></td>
			  </tr>
