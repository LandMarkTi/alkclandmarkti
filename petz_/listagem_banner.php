...
$sql = "SELECT * FROM banner where tipoBanner=".$_SESSION['id']." ORDER BY tipoBanner ASC ";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from banner where tipoBanner=".$_SESSION['id']." ";
   ...
   <form method="post" action="#" id="frm-filtro">
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
		        ...
		        <td><?php echo("Banner Esquerda"); ?></td>
                <td><?php echo $linha['link']; ?></td>
                <td><?php echo str_replace("http://www.megapedigree.com.br/site","",$linha['foto']); ?></td>
