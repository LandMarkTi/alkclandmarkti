...
$qv=mysql_query('select * from ped_vendas join ped_res using(id_ped,id_f) where ped_vendas.id_f='.$linha['id_f'].' and ped_vendas.id_ped='.$linha['id_ped']);
...
?>
        <tr>
			...
			<td><input type="checkbox" <? echo 'checked';?>></td>
