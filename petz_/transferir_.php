   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Lista de Pedigree  com transferência       
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
			...
			<td><?php echo date("d/m/Y",$linha['emissao']); ?></td>
		        <td valign="middle"><a href="reparar_transferir.php?id=<?php echo $linha['id_ped']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> </td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
