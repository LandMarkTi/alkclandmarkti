...
$sql = "SELECT * FROM medalha WHERE id='$_GET[id]'";
    ...
    <div id="internas_box">
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
  			  ...
  			  <tr>
    				<td align="right">Nome Medalha:</td>
    				<td>
                    <input name="link" type="text" class="forms" id="nome" size="85" required="required" value="<?php echo $linha['nomeMedalha']; ?>"/>
                    </td>
			  </tr>
              
              <tr>
    				<td align="right">Comissão:</td>
    				<td><input name="link" type="url" class="forms" id="link" size="85" required="required" value="<?php echo $linha['comissao']; ?>"/></td>
			  </tr>
         ...
         <div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Imagens Cadastradas</div>
         	...
         	<div style="margin:10px; margin-top:50px;">
           	  ...
           	  <div id="moldura_fotos"><a href="../images/medalhas/<?php echo $linha['fotoM']; ?>" id="thumb1" onclick="return hs.expand(this, miniGalleryOptions1)"><img src="corta_imagem.php?arquivo=../images/medalhas/<?php echo $linha['fotoM']; ?>&amp;largura=144&amp;altura=111" border="0" /></a>
