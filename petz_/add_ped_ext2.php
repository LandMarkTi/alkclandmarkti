...
<form action="sucesso_pedigree_ext.php" method="post" class="pedform" enctype="multipart/form-data">
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo" style="color:white">Pedigree Sobraci
