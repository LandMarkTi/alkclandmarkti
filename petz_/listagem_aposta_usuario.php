...
$sql = "SELECT * FROM aposta WHERE idUsuario <> '16' ORDER BY idAposta DESC ";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from aposta WHERE idUsuario <> '16'";
...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		$("#yesno").click(function() {
				...
				$.post("deletar_varios_aposta.php", 
								  {id: files
				},
								  function(retorno){
									 //$("#check").html(retorno);
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Lista de Aposta          
          ...
          <div style="float:right; margin-right:10px;"><a class="botao" href="cadastrar_aposta.php"><img src="images/botoes/novo.png" border="0" title="Cadastrar Novo"></a></div>
          </div>
         <div>
      ...
      <thead>
        <tr>
		  ...
		  <th width="34">Id</th>
		  <th width="127">Data Inicial</th>
          <th width="127">Data Final</th>
          <th width="344">Titulo Aposta</th>
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
				<td height="25" align="center"><input type="checkbox" value="<?php echo $linha['idAposta']; ?>" name="marcar[]" class="cinput" /></td>
		        <td height="25" align="center"><?php echo $linha['idAposta']; ?></td>
		        <td><?php echo date("d/m/Y",$linha['dataInicial']); ?></td>
                <td><?php echo date("d/m/Y",$linha['dataFinal']); ?></td>
                <td><?php echo $linha['tituloAposta']; ?></td>
		        <td valign="middle"><a href="reparar_aposta.php?id=<?php echo $linha['idAposta']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> <a href="#" id="yesno<?php echo $linha['idAposta']; ?>"><img src="images/icons/excluir.png" title="Excluir" alt="Excluir" border="0" onClick="ConfirmaExclusao(<?php echo $linha['idAposta']; ?>);"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
