 ...
 <div id="internas_margem_full">
    <div id="internas_box2">
   	  <div id="internas_principal2">
    	  <div class="arial_branco20" id="internas_titulo">FORMULÁRIO PARA FILIAÇÃO E ABERTURA DE CANIL <br>         
            <div style="float:right; margin-left:10px;"><a class="botao" onClick='history.go(-1)'></a></div>                   
          </div>
         <div style="display:table;margin: 87px;margin-left: 115px;"> 
        <form action="env_filiacao_escolha.php" onsubmit="return valida();" method="post">
Núcleo:<select name="nid"><?php echo $sel;?></select>
<p class="P2">&nbsp;</p><p class="P4"><span class="T1">1º Nome (TITULAR): <input name="nome" onkeyup="$('#nome_completo').val(this.value);" style="width:604px"></span></p><p class="P2">&nbsp;</p><p class="P4"><span class="T1">2º Nome: <input name="sobrenome" style="width:674px"></span></p><p class="P2">&nbsp;</p><p class="P4"><span class="T1">Nacionalidade: <input name="nacionalidade" >Estado Civil: <input name="estado_civil" >Profissão: <input name="profissão" style="width: 159px;"></span></p>
<p class="P2">&nbsp;</p><p class="P4"><span class="T1">Data de Nasc: <input name="Nascimento" id="nasc">CPF:<input name="cpf" >RG:<input name="RG" style="width: 244px;"></span></p><p class="P2">&nbsp;</p><p class="P2"><p class="P4"><span class="T1">CEP:<input name="cep" id="cep" maxlength="9" onkeyup="$('#cep_corresp').val(this.value);" onblur="getEndereco();">E-mail: <input name="email" id="em" size="25"> Copiar Endereço para Correspondência: <b style="cursor:pointer;" onclick="conf(this);">☑</b> </span></p>&nbsp;</p><p class="P4"><span class="T1">Bairro: <input name="bairro" onkeyup="$('#bairro_corresp').val(this.value);">Cidade:<input name="cidade" onkeyup="$('#cidade_corresp').val(this.value);" style="width: 282px;" onblur="$('#local_assinatura').val(this.value);" >Est:<input name="estado" ></span></p><p class="P2">&nbsp;</p>
<p class="P4"><span class="T1">End. Residencial: <input name="End_residencial" style="width:630px" onkeyup="$('#end_corresp').val(this.value);"></span></p><p class="P2">&nbsp;</p>

<p class="P4"><span class="T1">Complemento: <input name="complemento" style="width:520px" id="com1"></span><span class="T1">Nº: <input id="com2" name="complemento" style="width:100px" ></span></p><p class="P2">&nbsp;</p>

<p class="P4"><span class="T3">End. p/ corresp. :</span><span class="T1"><input name="end_corresp" id="end_corresp" size="79"></span></p><p class="P2">&nbsp;</p><p class="P4"><span class="T1">Bairro: <input name="bairro_corresp" id="bairro_corresp">Cidade: <input name="cidade_corresp" style="width: 270px;" id="cidade_corresp" >CEP:<input name="cep_corresp" id="cep_corresp" ></span></p><p class="P2">&nbsp;</p>
<p class="P4"><span class="T1">DDD: <input name="ddd" size="2">Fones Resid:<input name="fone_res" > Com:<input name="fone_com" style="width: 185px;">Fax:<input name="fone_fax" ></span></p><p class="P2">&nbsp;</p><p class="P2">&nbsp;</p><p class="P4"><span class="T4">Solicito o Registro do Canil de minha propriedade conforme as opções de nomes abaixo relacionadas:</span></p><p class="P2">&nbsp;</p>
...
<p class="P2">&nbsp;</p><p class="P5"> </p><p class="P6"><span class="T1">O canil acima será utilizado como: (<input type="radio" value="prefixo" name="uso_canil" checked="checked"> ) Prefixo                ( <input type="radio" value="sulfixo" name="uso_canil">   ) Sufixo</span></p><p class="P2">&nbsp;</p>
<p class="P2">&nbsp;</p><p class="P4"><span class="T1">Criador das Raças: <input  name="Raças" style="width:600px"></span></p><p class="P2">&nbsp;</p>
<p class="P4" style="width: 724px;"><span class="T4">Eu,<input name="nome_completo" id="nome_completo">, conforme dados acima, por não ser associado e sim filiado da SOCIEDADE BRASILEIRA DE CINOFILIA, isento de taxas e contribuições a título de Sociedade, comprometo-me a acatar, respeitar, seguir e fazer com que sigam os seus  Regimentos e Regulamentos, sob a pena de exclusão da filiação,
 ...
 Declaro sob minha responsabilidade que não existe nome análogo ou semelhante e eximo a entidade filiadora de qualquer responsabilidade.</span></p><p class="P3"> </p><p class="P3"> </p><p class="P4"><span class="T4">Local e Data:<input maxlength="15" size="20" name="local_assinatura" id="local_assinatura">,<input maxlength="10" size="2" name="dia_assinatura" value='<?php echo date("d",time());?>'> de <input maxlength="10" size="10" name="mes_assinatura" value='<?php echo date("m",time());?>'> de <input maxlength="10" size="4" id="final" name="ano_assinatura" value='<?php echo date("Y",time());?>'></span></p><p class="P8"> </p><p class="P8"> </p><p class="P9"><span class="T4"> </span></p>
