   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Taxi Pet       
          <p style="background-color:white;color:black;padding:15px"> <br><br>
 1)     Sr. Mário Navarro – Telefone (11) 9 5551-7836
<br><br>
2)     Nicolas – Telefone (11) 9 6912-5178
<br><br>
3)     Sheila – Telefone (11) 9 9936-8198
<br><br>
</p>
          </div>
         <div>
