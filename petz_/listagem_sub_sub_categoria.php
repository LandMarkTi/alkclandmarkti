...
$sql = "SELECT c.idCategoria,
			   ...
			   s.idCategoria,
			   s.nomeSubcategoria,
			   ss.idSubSubCategoria,
			   ss.idCategoria,
			   ss.idSubCategoria,
			   ss.nomeSubSubCategoria FROM subsubcategoria ss JOIN categoria c ON
			   c.idCategoria = ss.idCategoria JOIN subcategoria s ON
			   s.idSubcategoria = ss.idSubCategoria  ORDER BY c.nomeCategoria,s.nomeSubcategoria,ss.nomeSubSubCategoria ASC";
$query = mysql_query($sql) or die(mysql_error());
//Pegando o TOTAL DE REGISTROS da tabel ADM
$total="select count(*) from subsubcategoria";
...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		$("#yesno").click(function() {
				...
				$.post("deletar_varios_subsubcategoria.php", 
								  {id: files
				},
								  function(retorno){
									 //$("#check").html(retorno);
	...
	function ConfirmaExclusao(id){
		...
		$("#yesno"+id).click(function() {
				$.post("deletar_subsubcategoria.php",
					{id: id},
	   				 function(retorno){
   ...
   <form method="post" action="#" id="frm-filtro">
      <p>
    	...
    	<div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Lista grupo da Sub-Categoria          
          ...
          <div style="float:right; margin-right:10px;"><a class="botao" href="cadastrar_sub_sub_categoria.php"><img src="images/botoes/novo.png" border="0" title="Cadastrar Novo"></a></div>
          </div>
         <div>
      ...
      <thead>
        <tr>
		  ...
		  <th width="37">Id</th>
		  <th width="295">Nome Categoria</th>
          <th width="299">Nome Sub-Categoria</th>
          <th width="299">Nome Sub-Sub-Categoria</th>
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
				<td height="25" align="center"><input type="checkbox" value="<?php echo $linha['idSubSubCategoria']; ?>" name="marcar[]" class="cinput" /></td>
		        <td height="25" align="center"><?php echo $linha['idSubSubCategoria']; ?></td>
		        <td><?php echo $linha['nomeCategoria']; ?></td>
                <td><?php echo $linha['nomeSubcategoria']; ?></td>
                <td><?php echo $linha['nomeSubSubCategoria']; ?></td>
		        <td valign="middle"><a href="reparar_sub_sub_categoria.php?id=<?php echo $linha['idSubSubCategoria']; ?>"><img src="images/icons/visualizar.png" title="Visualizar" alt="Visualizar" border="0"/></a> <a href="#" id="yesno<?php echo $linha['idSubSubCategoria']; ?>"><img src="images/icons/excluir.png" title="Excluir" alt="Excluir" border="0" onClick="ConfirmaExclusao(<?php echo $linha['idSubSubCategoria']; ?>);"/></a></td>
        </tr>
       <?php } ?>
      </tbody>
    </table>
