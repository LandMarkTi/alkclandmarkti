...
<p class="P2">&nbsp;</p><p class="P4"><span class="T1">Data de Nasc: <input name="Nascimento" id="nasc">CPF:<input name="cpf" >RG:<input name="RG" style="width: 244px;"></span></p><p class="P2">&nbsp;</p><p class="P4"><span class="T1">End. Residencial: <input name="End_residencial" style="width:630px" onkeyup="$('#end_corresp').val(this.value);"></span></p><p class="P2">&nbsp;</p><p class="P4"><span class="T1">Bairro: <input name="bairro" onkeyup="$('#bairro_corresp').val(this.value);">Cidade:<input name="cidade" onkeyup="$('#cidade_corresp').val(this.value);" style="width: 282px;" onblur="$('#local_assinatura').val(this.value);" >Est:<input name="estado" ></span></p><p class="P2">&nbsp;</p>
<p class="P4"><span class="T1">CEP:<input name="cep" id="cep" maxlength="9" onkeyup="$('#cep_corresp').val(this.value);" >E-mail: <input name="email" id="em" size="25"> Copiar Endereço para Correspondência: <b style="cursor:pointer;" onclick="conf(this);">☑</b> </span></p><p class="P2">&nbsp;</p><p class="P4"><span class="T3">End. p/ corresp. :</span><span class="T1"><input name="end_corresp" id="end_corresp" size="79"></span></p><p class="P2">&nbsp;</p><p class="P4"><span class="T1">Bairro: <input name="bairro_corresp" id="bairro_corresp">Cidade: <input name="cidade_corresp" style="width: 270px;" id="cidade_corresp" >CEP:<input name="cep_corresp" id="cep_corresp" ></span></p><p class="P2">&nbsp;</p>
