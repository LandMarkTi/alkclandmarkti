...
//echo "<a href='$lkk' >(Clique aqui para ativar o plano de saúde)</a>";

$msg="<html><body><br><br><p>Obrigado pela transferência do seu pet, aproveite essa promoção por tempo limitado:</p>
<br><br>
<p>
<br>
<img  src='http://megapedigree.com/petz/images/bannerpetz2.png'>
</p>




Enviado pelo sistema sobraci</body></html>
";
...
$envio = mail(trim($_POST['email']), "Oferta Petz ".date('d/m/Y') , "$msg", $headers,'-rcomercial@conveniosaudepet.com.br');
