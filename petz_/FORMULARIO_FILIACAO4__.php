...
<p class="P4"><span class="T1">End. Residencial: <input name="End_residencial" style="width:630px" onkeyup="$('#end_corresp').val(this.value);"></span></p><p class="P2">&nbsp;</p><p class="P4"><span class="T3">End. p/ corresp. :</span><span class="T1"><input name="end_corresp" id="end_corresp" size="79"></span></p><p class="P2">&nbsp;</p><p class="P4"><span class="T1">Bairro: <input name="bairro_corresp" id="bairro_corresp">Cidade: <input name="cidade_corresp" style="width: 270px;" id="cidade_corresp" >CEP:<input name="cep_corresp" id="cep_corresp" ></span></p><p class="P2">&nbsp;</p>
...
$('input[name="fone_res"]').mask("(99)9999-9999");
$('input[name="fone_com"]').mask("(99)9999-9999");
$('input[name="fone_fax"]').mask("(99)9999-9999");
...
function valida(){
	...
	$('input[size!="1"]').each(function(index,elem){if($(elem).val()==''){retorno=false;}});
	...
	$('input[size!="1"]').each(function(index,elem){if($(this).val()==''){$(this).val("Campo Obrigatório");$(this).css('background-color','pink');$(this).focus(function(){$(this).css('background-color','white');$(this).val('');});}});
	}
	if(retorno){
//conteudo
