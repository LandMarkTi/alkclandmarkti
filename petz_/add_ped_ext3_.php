...
if($_SESSION['id']!=44)$fraca=' and idSubcategoria NOT IN (332,160) ';
...
<form action="sucesso_pedigree_ext_outra.php" method="post" class="pedform" enctype="multipart/form-data">
