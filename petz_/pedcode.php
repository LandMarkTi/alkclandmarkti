...
if($ncode<1|| $dcode['id_filhote']==0)die('<script>location=\'http://www.megapedigree.com.br/painel_geral_123/imprime_rgc/ver_carteirinha.php?code='.$_GET['code'].'\';</script>');
...
echo "<html><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"><body style='font-size: 9;'><div style=\"background-image:url('http://www.sobraci.org/c/fundoPL.jpg');background-size:100%;width:21cm;height:30cm\">";
