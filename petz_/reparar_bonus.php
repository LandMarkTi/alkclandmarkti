...
$sql = "SELECT * FROM pontos WHERE id_pontos='$_GET[id]'";
 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
   	  <div id="internas_principal">
    	  <div class="arial_branco20" id="internas_titulo">Atualizar pontos          
         ...
         <div style="margin:10px; margin-top:50px;">
            <form action="reparar_sucesso_ponto.php" method="post">
            <input type="hidden" name="id" id="id" value="<?php echo $_GET['id']; ?>" />
            &nbsp;
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
            
  			  <tr>
    				<td align="right">Nome Bonus:</td>
    				<td>
                    <input name="link" type="text" class="forms" id="nome" size="55" required="required" value="<?php echo $linha['nome_ponto']; ?>"/>
                    </td>
			  </tr>
              
              <tr>
    				<td align="right">Pontos:</td>
    				<td><input name="link" type="text" class="forms" id="link" size="55" required="required" value="<?php echo $linha['qtd']; ?>"/></td>
			  </tr>
