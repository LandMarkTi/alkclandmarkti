...
$sql = "INSERT INTO pedigree VALUES('',$criador,'$nomecao','$micro',$raca,'$var',$datanasc,'$sex','$pais','$registro',$dataEmissao,'$ninhada_no','$amigo','$proprietario','$nome_criador','$end','$ns','$ss','$cs','$ps','$obs')";
...
mysql_query("update somatoria set ped_ri=ped_ri+1 where 1");
