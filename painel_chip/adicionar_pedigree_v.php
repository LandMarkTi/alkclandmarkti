				...
				<div class="wrappern">
				  ...
				  <div class="ng23">
					<br> <input value="Nome Filhote" name="n[]"  maxlength="20"  size="13"><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="">selecione..</option><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span><br><br> <input value="Nome Filhote" name="n[]"  maxlength="20"  size="13"><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="">selecione..</option><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span>
				     ...
				     <div class="nwp3">
				  <div class="ng31">
					<center style="color:#5d5c5c;font-size:15px;">Nascidos na <br> Ninhada</center>
				  </div>
				  <div class="ng32">
					<br> <input value="Nome Filhote" name="n[]"  maxlength="20"  size="13"><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="">selecione..</option><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span><br><br> <input value="Nome Filhote" name="n[]"  maxlength="20"  size="13"><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="">selecione..</option><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span>
				  </div>
				  ...
				  <div class="ng52">
					<br> <input value="Nome Filhote" name="n[]"  maxlength="20"  size="13" readonly><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="">selecione..</option><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span><br><br> <input value="Nome Filhote" name="n[]"  maxlength="20"  size="13" readonly><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="">selecione..</option><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span>
				  </div>
				  <div class="ng53">
					<br> <input value="Nome Filhote" name="n[]"  maxlength="20"  size="13" readonly><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="">selecione..</option><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span><br><br> <input value="Nome Filhote" name="n[]"  maxlength="20"  size="13" readonly><span style="display:none;background-color:gray;"><br><select name="s[]"><option value="">selecione..</option><option value="Masc">Masc</option><option value="Fêmea">Fêmea</option></select><br> <input value="cor.." class="ccc" name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span>
				  </div>
