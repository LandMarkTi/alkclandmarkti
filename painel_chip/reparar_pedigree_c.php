 ...
 <div id="internas_margem_full">
	...
	<input class="parent" name="p[]"><br><input class="parent" name="p[]">
              ...
              <tr>
                <td align="right">&nbsp;</td>
                <td class="opts">
                <a href="#" class="button" onclick="return false;">Pagar Pedigree</a> <a href="#" class="button" onclick="$('#fot').click();" style="display:none">Pagar Pedigree com foto</a> <a class="button" href="print_Pedigree.php?id=<?php echo $_GET['id'];?>">Visualizar</a>
                </td>            
              </tr>
...
<input type="hidden" name="receiverEmail" value="<?php 
		$idc=$_SESSION['cid'];
		//echo $_SESSION['cid'];
		$sql_cred="select * from criadores join tokens_ps on criadores.id_credenciado=tokens_ps.id_ps where id_criador=".$idc;
		
		$dcred=mysql_query($sql_cred)or die(mysql_error());
		$ff=mysql_fetch_assoc($dcred);
		echo $ff['em_cred'];
		//print_r($ff);
		?>" />
