...
$.get( "post_progenitores_import.php?id=<?php echo $_SESSION['cid'];?>&pt=1&r="+Math.random(), function( data ) {
  $('#pai1').html( data );
...
$.get( "post_progenitores_import.php?id=<?php echo $_SESSION['cid'];?>&pt=2&r="+Math.random(), function( data ) {
  $('#pai2').html( data );
...
$('#subcategoria').val(<?=$_GET['r']?>).change().hide().after($('#subcategoria option:selected').text());
<?php
}
