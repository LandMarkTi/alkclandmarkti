...
$.get( "post_progenitores_import2.php?id=<?php echo $_SESSION['cid'];?>&pt=1&rac=<?=$_GET['r']?>", function( data ) {
  $('#pai1').html( data );
...
$.get( "post_progenitores_import2.php?id=<?php echo $_SESSION['cid'];?>&pt=2&rac=<?=$_GET['r']?>", function( data ) {
  $('#pai2').html( data );
