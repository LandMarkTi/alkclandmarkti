...
mysql_query("insert into ped_land values('','$id_ped','$f','/painel_criador/storeResize/$fotonome')")or die('ee');
}
...
mysql_query("insert into ped_land values('','$id_ped','$f','mm_/painel_criador/storeResize/$fotonome')")or die('ee');
}
...
mysql_query("insert into ped_land values('','$id_ped','$f','pp_/painel_criador/storeResize/$fotonome')")or die('ee');
