 ...
 <div id="internas_margem_full">
    ...
    <div id="internas_box">
         ...
         <div style="margin:10px; margin-top:50px;">
			...
			<table width="100%" border="0" cellspacing="6" cellpadding="0">
  			  ...
  			  <tr>
    				...
    				<td><input name="tituloAposta" type="text" class="forms" id="tituloAposta" size="65" required/></td>
			  </tr>
			 <tr>
        ...
        <tr>
    				...
    				<td><input name="variedade" type="text" class="forms"  size="65" required/></td>
			  </tr>
              <tr>
    				<td align="right"><label for="dataInicial" class="arial_cinza2_12" >Data Nascimento:</label></td>
    				<td><input name="dataInicial" type="text" class="forms" id="dataInicial" size="65" required/>
              ...
              <tr>
    				...
    				<td><input name="sexo" type="text" class="forms"  size="65" required/></td>
			  </tr>
              ...
              <tr style="display:none;">
    				...
    				<td><input name="registro" type="text" class="forms"  size="65" required/></td>
			  </tr>

		
                <tr>
    				<td align="right"><label for="dataInicial" class="arial_cinza2_12" >Data Emissão:</label></td>
    				<td><input name="dataFinal" type="text" class="forms" id="dataFinal" size="65" required/>
              ...
              <tr>
    				...
    				<td><input name="ninhada_no" type="text" class="forms"  size="65" required/></td>
			  </tr>


              <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >Amigo:</label></td>
    				<td><input name="amigo" type="text" class="forms"  size="65" required/></td>
			  </tr>

              <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >criador:</label></td>
    				<td><input name="criador" type="text" class="forms"  size="65" required/></td>
			  </tr>

              <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >foto:</label></td>
    				<td><input name="foto" type="file" class="forms"  size="65" required/></td>
			  </tr>


              <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >Proprietário:</label></td>
    				<td><input name="proprietario" type="text" class="forms"  size="65" required/></td>
			  </tr>


              <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >Endereço:</label></td>
    				<td><input name="endereço" type="text" class="forms"  size="65" required/></td>
			  </tr>

              <tr>
    				<td align="right"><label for="tituloAposta" class="arial_cinza2_12" >ninhada:</label></td>
    				<td><input name="bloco_ninhada" type="hidden" class="forms"  size="65" required/>
				...
				<div class="wrappern">
				  ...
				  <div class="ng14">
					<center style="color:white;font-size:14px;padding-top: 11px;">Nascidos<hr>M | F</center>
				  </div>
				  <div class="ng15">
				  ...
				  <div class="ng22">
					<br> <input name="n[]" size="13"><span style="display:none;background-color:gray;"><br> <input type="radio" name="s[]" value="masc">M <input type="radio" name="s[]" value="fem">F<br> <input value="cor.." name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span><br><br> <input name="n[]" size="13"><span style="display:none;background-color:gray;"><br> <input type="radio" name="s[]" value="masc">M <input type="radio" name="s[]" value="fem">F<br> <input value="cor.." name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span>
				  </div>
				  <div class="ng23">
					<br> <input name="n[]" size="13"><span style="display:none;background-color:gray;"><br> <input type="radio" name="s[]" value="masc">M <input type="radio" name="s[]" value="fem">F<br> <input value="cor.." name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span><br><br> <input name="n[]" size="13"><span style="display:none;background-color:gray;"><br> <input type="radio" name="s[]" value="masc">M <input type="radio" name="s[]" value="fem">F<br> <input value="cor.." name="c[]" size="13"><br><button type="button" onclick="$(this).parent().slideUp();">ok</button></span>
				  </div>
...
<script>
$('input[size="13"]').click(function(){$(this).next().show('800').css('z-index','200');});
</script>
<style>
.parent{
width:85%;
...
.ng13 input{padding-top:10px;margin-top:4px;font-size:18px}
.ng14{
	height: 55px;
	background-color: rgb(130, 130, 130);
	margin-top: 
...
.ng15 input{padding-top:10px;margin-top:4px;font-size:18px}
.nwp2{
	position: relative;
	float: left;
	left: 6px;
