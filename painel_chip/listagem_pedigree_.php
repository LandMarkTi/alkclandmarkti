...
$sql = "SELECT  *,pedigree.id_criador as cid  FROM  `pedigree`  JOIN criadores ON pedigree.id_criador = criadores.id_criador JOIN subcategoria ON pedigree.id_raca=subcategoria.idSubcategoria  WHERE pedigree.id_criador=$_SESSION[id]";
   ...
   <form method="post" action="#" id="frm-filtro">
      ...
      <?php  while($linha = mysql_fetch_array($query)) {?>
        <tr>
			...
			<td><?php echo $linha['nome_criador']; ?></td>
